...
- [pgEdge/pgedge-vectorizer](https://github.com/pgEdge/pgedge-vectorizer) - A PostgreSQL extension to create chunk tables for existing text data, and populate them with embeddings using your favourite LLM.
- [colonelpanichacks/drone-mesh-mapper](https://github.com/colonelpanichacks/drone-mesh-mapper) - Send WiFi Drone RemoteID detections over serial via Meshtastic
...
- [cowsql/cowsql](https://github.com/cowsql/cowsql) - Embeddable, replicated and fault tolerant SQL engine.
...
- [RafiaSabih/pg_auth_mon](https://github.com/RafiaSabih/pg_auth_mon) - Postgres extension for monitoring client authentication attempts
...
- [dorkamotorka/transparent-proxy-ebpf](https://github.com/dorkamotorka/transparent-proxy-ebpf) - Transparent Proxy Implementation using eBPF and Go
- [dorkamotorka/redis-ebpf](https://github.com/dorkamotorka/redis-ebpf) - Redis Observability using eBPF
- [CrunchyData/pg_incremental](https://github.com/CrunchyData/pg_incremental) - Incremental Data Processing in PostgreSQL
...
- [pgEdge/spock](https://github.com/pgEdge/spock) - Logical multi-master PostgreSQL replication
...
- [microsoft/dev-tunnels-ssh](https://github.com/microsoft/dev-tunnels-ssh) - SSH library for dev-tunnels
...
- [gmbeard/shadow-cast](https://github.com/gmbeard/shadow-cast) - GPU accelerated screen and audio recording for Linux
...
- [deeploy-sh/deeploy](https://github.com/deeploy-sh/deeploy) - Modern Deployment. Terminal First. Open Source.
...
- [seal-io/hermitcrab](https://github.com/seal-io/hermitcrab) - Available Terraform Provider network mirroring service.
...
- [mycroft/rss-to-bluesky](https://github.com/mycroft/rss-to-bluesky) - A stupid program that fetches the lobste.rs RSS feed, and posts it to bluesky.
- [fortio/proxy](https://github.com/fortio/proxy) - Fortio simple TLS/ingress proxy
...
- [AmadeusITGroup/uvbox](https://github.com/AmadeusITGroup/uvbox) - Fast, simple and cross-platform Python application packaging
...
- [coreruleset/go-ftw](https://github.com/coreruleset/go-ftw) - Web Application Firewall Testing Framework - Go version
- [coreruleset/crs-toolchain](https://github.com/coreruleset/crs-toolchain) - The Swiss army knife for CRS developers
- [corazawaf/coraza-spoa](https://github.com/corazawaf/coraza-spoa) - A wrapper for integrating the OWASP Coraza WAF with HAProxy's SPOE filters.
...
- [mittwald/brudi](https://github.com/mittwald/brudi) - Easy, incremental and encrypted backup creation / restoration for different backends (file, mongoDB, mysql, postgres, etc.)
...
- [lechgu/tichy](https://github.com/lechgu/tichy) - 
...
- [sandrolain/goncurrently](https://github.com/sandrolain/goncurrently) - Flexible command-line tool for running multiple commands concurrently
...
- [supercaracal/scram-sha-256](https://github.com/supercaracal/scram-sha-256) - Password-encryption tool for PostgreSQL with scram-sha-256
...
- [wandb/catnip](https://github.com/wandb/catnip) - Like catnip, a highly addictive agentic coding tool
- [fetch-kit/chaos-proxy-go](https://github.com/fetch-kit/chaos-proxy-go) - Golang port of chaos-proxy
- [samber/do](https://github.com/samber/do) - ⚙️  A dependency injection toolkit based on Go 1.18+ Generics.
- [samber/hot](https://github.com/samber/hot) - 🌶️ In-memory caching library for read-intensive Go applications
...
- [andrei-polukhin/pgdbtemplate](https://github.com/andrei-polukhin/pgdbtemplate) - Go library for creating PostgreSQL test databases using template databases for lightning-fast test execution.
...
- [alikhil/kubectl-find](https://github.com/alikhil/kubectl-find) - Missing kubectl UNIX-find-like plugin to find resources and perform action on them
...
- [bucketeer-io/bucketeer](https://github.com/bucketeer-io/bucketeer) - Feature Flag Management and A/B Testing platform
...
- [zhulik/pal](https://github.com/zhulik/pal) - An (opinionated) dependency injection framework for Go.
...
- [dbos-inc/dbos-transact-golang](https://github.com/dbos-inc/dbos-transact-golang) - Lightweight Durable Golang Workflows
...
- [go-orb/go-orb](https://github.com/go-orb/go-orb) - Go-Orb is a framework for building both monoliths and distributed systems in Go.
...
- [storacha/piri](https://github.com/storacha/piri) - 🌶️ Storacha Storage Node
- [mingrammer/gosearch](https://github.com/mingrammer/gosearch) - :mag: Search the Go packages via command-line
- [daangn/autopprof](https://github.com/daangn/autopprof) - Automatically profile the Go applications when CPU or memory utilization crosses threshold
- [mingrammer/keyflare](https://github.com/mingrammer/keyflare) - Lightweight client-side hot key detector for distributed cache systems
- [hasirciogluhq/xdatabase-proxy](https://github.com/hasirciogluhq/xdatabase-proxy) - A high-performance database proxy service built with Go, designed for Kubernetes environments. Provides secure and scalable database connection management with support for multiple database types.
- [docker/model-runner](https://github.com/docker/model-runner) - Docker Model Runner
- [yohimik/goxash3d-fwgs](https://github.com/yohimik/goxash3d-fwgs) - Xash3D-FWGS CGO Wrapper
...
- [rancher/eks-operator](https://github.com/rancher/eks-operator) - 
...
- [rancher/artifact-mirror](https://github.com/rancher/artifact-mirror) - 
...
- [appvia/terranetes-controller](https://github.com/appvia/terranetes-controller) - The terranetes controller manages the lifecycle of an OpenTofu or Terraform resource, allowing developers to self-serve dependencies in a controlled manner.
...
- [kkb0318/kubernetes-mcp](https://github.com/kkb0318/kubernetes-mcp) - 
...
- [rajsinghtech/tsflow](https://github.com/rajsinghtech/tsflow) - Network flow visualizer for Tailscale -  Requires Premium TS plans
...
- [hashmap-kz/pgrwl](https://github.com/hashmap-kz/pgrwl) - Cloud-Native PostgreSQL WAL receiver. Stream, compress, encrypt, upload, retain and monitor your WAL archive.
...
- [orches-team/orches](https://github.com/orches-team/orches) - Simple git-ops for Podman and systemd
- [a-ve/wicketkeeper](https://github.com/a-ve/wicketkeeper) - A privacy-friendly, self-hostable Proof-of-Work (PoW) CAPTCHA
- [darksworm/go-wol-proxy](https://github.com/darksworm/go-wol-proxy) - A Wake-on-LAN reverse-proxy service that automatically wakes up servers when requests are made to them.
- [microsoft/tyger](https://github.com/microsoft/tyger) - Remote signal processing.
...
- [aws-controllers-k8s/code-generator](https://github.com/aws-controllers-k8s/code-generator) - Code generator for AWS Controllers for Kubernetes
...
- [werf/nelm](https://github.com/werf/nelm) - Nelm is a Helm 4 alternative. It is a Kubernetes deployment tool that manages Helm Charts and deploys them to Kubernetes. The Nelm goal is to provide a modern alternative to Helm, with long-standing i
...
- [cedar-policy/cedar-access-control-for-k8s](https://github.com/cedar-policy/cedar-access-control-for-k8s) - Cedar for Kubernetes brings the power of Cedar to Kubernetes authorization and admission validation, showing how cluster administrators can enable a unified access control language for principals maki
- [neilalexander/yggmail](https://github.com/neilalexander/yggmail) - End-to-end encrypted email for the mesh networking age
- [crowdsecurity/cs-aws-waf-bouncer](https://github.com/crowdsecurity/cs-aws-waf-bouncer) - Crowdsec bouncer for AWS WAF
- [crowdsecurity/cs-cloudflare-bouncer](https://github.com/crowdsecurity/cs-cloudflare-bouncer) - A CrowdSec Bouncer that syncs the decisions made by CrowdSec with CloudFlare's firewall. Manages multi user, multi account, multi zone setup. Supports IP, Country and AS scoped decisions.
- [crowdsecurity/cs-firewall-bouncer](https://github.com/crowdsecurity/cs-firewall-bouncer) - Crowdsec bouncer written in golang for firewalls
- [google/osv-scanner](https://github.com/google/osv-scanner) - Vulnerability scanner written in Go which uses the data provided by https://osv.dev
- [yaacov/kubectl-sql](https://github.com/yaacov/kubectl-sql) - kubectl-sql is a kubectl plugin that use SQL like language to query the Kubernetes cluster manager
...
- [mikaelhg/litesync](https://github.com/mikaelhg/litesync) - Self-hosted Brave sync server
...
- [k0rdent/kcm](https://github.com/k0rdent/kcm) - 
- [vjerci/gochromecast](https://github.com/vjerci/gochromecast) - A simple tool to stream your media to android TV or chromecast device
...
- [dash0hq/dash0-operator](https://github.com/dash0hq/dash0-operator) - Dash0 Operator for Kubernetes
- [kubewharf/kubezoo](https://github.com/kubewharf/kubezoo) - a lightweight kubernetes multi-tenancy gateway
- [h3poteto/aws-global-accelerator-controller](https://github.com/h3poteto/aws-global-accelerator-controller) - A Kubernetes controller for Global Accelerators and Route53
...
- [aws/eks-hybrid](https://github.com/aws/eks-hybrid) - Use your on-premises and edge infrastructure as nodes in EKS clusters with EKS Hybrid Nodes
- [voidDB/voidDB](https://github.com/voidDB/voidDB) - A transactional key-value database written in Go for Linux and macOS
...
- [magodo/terraform-provider-restful](https://github.com/magodo/terraform-provider-restful) - Terraform provider to manage RESTful resources
...
- [Mellanox/network-operator](https://github.com/Mellanox/network-operator) - NVIDIA Network Operator
...
- [pidanou/helm-tui](https://github.com/pidanou/helm-tui) - A simple terminal UI for Helm
...
- [go-dockly/garm](https://github.com/go-dockly/garm) - Advanced ARM64 Compiler for High-Performance on the GO
...
- [comradequinn/kapi](https://github.com/comradequinn/kapi) - kapi provides a simplified interface to the controller-runtime library.
...
- [social-protocols/quality-news](https://github.com/social-protocols/quality-news) - Quality News - Towards a fairer ranking formula for Hacker News
...
- [idsulik/helm-cel](https://github.com/idsulik/helm-cel) - A Helm plugin that uses Common Expression Language (CEL) to validate values. Instead of using JSON Schema in values.schema.json, you can write more expressive validation rules using CEL in values.cel.
...
- [opentofu/terraform-provider-lua](https://github.com/opentofu/terraform-provider-lua) - Experimental
- [opentofu/terraform-provider-go](https://github.com/opentofu/terraform-provider-go) - Experimental
- [opentofu/terraform-provider-external](https://github.com/opentofu/terraform-provider-external) - Utility provider that exists to provide an interface between Terraform and external programs. Useful for integrating Terraform with a system for which a first-class provider does not exist.
...
- [Excoriate/daggerverse](https://github.com/Excoriate/daggerverse) - A collection of Dagger modules powered by Dagger.
- [Dudesons/daggerverse](https://github.com/Dudesons/daggerverse) - 
...
- [Aureum-Cloud/Cloudflare-DDNS](https://github.com/Aureum-Cloud/Cloudflare-DDNS) - Cloudflare DDNS is a Go-based DNS updater designed to keep your Cloudflare-managed DNS records in sync with your current public IPv4 and/or IPv6 addresses.
- [crossplane-contrib/provider-http](https://github.com/crossplane-contrib/provider-http) - Crossplane Provider designed to facilitate sending HTTP requests as resources.
...
- [aws-controllers-k8s/eks-controller](https://github.com/aws-controllers-k8s/eks-controller) - ACK service controller for Amazon Elastic Kubernetes Service (EKS)
...
- [loft-sh/cluster-api-provider-vcluster](https://github.com/loft-sh/cluster-api-provider-vcluster) - 
...
- [RoseSecurity/Kuzco](https://github.com/RoseSecurity/Kuzco) - Kuzco reviews your Terraform and OpenTofu resources, compares them to the provider schema to detect unused parameters, and uses AI to suggest improvements and fixes
...
- [isometry/terraform-provider-deepmerge](https://github.com/isometry/terraform-provider-deepmerge) - Deepmerge functions for Terraform 1.8+ & OpenTofu
...
- [go-kod/kod](https://github.com/go-kod/kod) - A generics based dependency injection application framework for Go, supporting aspect oriented programming based on interceptors
...
- [pulumi/esc](https://github.com/pulumi/esc) - Pulumi ESC is a centralized, secure service for environments, secrets, and configuration management, optimized for multi-cloud infrastructures and applications.
...
- [notaryproject/ratify](https://github.com/notaryproject/ratify) - Artifact Ratification Framework (CNCF Sandbox)
...
- [Clivern/Goenv](https://github.com/Clivern/Goenv) - 🐺 Manage Your Applications Go Environment.
...
- [maxpoletaev/dendy](https://github.com/maxpoletaev/dendy) - NES/Famicom emulator with P2P network multiplayer and WASM support
...
- [mutablelogic/go-media](https://github.com/mutablelogic/go-media) - go media services and ffmpeg bindings for golang
- [openfaas/of-watchdog](https://github.com/openfaas/of-watchdog) - Reverse proxy/middleware for functions using STDIO/HTTP
...
- [outscale/osc-bsu-csi-driver](https://github.com/outscale/osc-bsu-csi-driver) - The OSC BSU CSI Driver is a CSI driver for Kubernetes allowing the use of Outscale Block Storage Units (BSU) volumes
...
- [google/go-attestation](https://github.com/google/go-attestation) - Libraries to abstract aspects of working with TPMs for the purposes of attestation
...
- [d2iq-archive/kubernetes-security-benchmark](https://github.com/d2iq-archive/kubernetes-security-benchmark) - A simple way to evaluate the security of your Kubernetes deployment against sets of best practices defined by various community sources
...
- [outbrain-inc/orchestrator](https://github.com/outbrain-inc/orchestrator) - MySQL replication topology manager/visualizer
...
- [GoogleCloudPlatform/accelerated-platforms](https://github.com/GoogleCloudPlatform/accelerated-platforms) - 
...
- [sighupio/module-aws](https://github.com/sighupio/module-aws) - AWS Module: additional components for EKS-based clusters on AWS
...
- [kronotop/kronotop](https://github.com/kronotop/kronotop) - Kronotop is a distributed document database that combines ACID transactions with simplicity at any scale.
...
- [datastax/cassandra-data-migrator](https://github.com/datastax/cassandra-data-migrator) - Cassandra Data Migrator - Migrate & Validate data between origin and target Apache Cassandra®-compatible clusters.
- [datastax-archive/dsbulk-migrator](https://github.com/datastax-archive/dsbulk-migrator) - 
...
- [eclipse-hawkbit/hawkbit](https://github.com/eclipse-hawkbit/hawkbit) - Eclipse hawkBit™
...
- [shane-borden/sqlScripts](https://github.com/shane-borden/sqlScripts) - Central collection of sql scripts that can help diagnose problems and expose metadata about various DBMS Products.
...
- [chdb-io/chdb-node](https://github.com/chdb-io/chdb-node) - Native NodeJS bindings for chDB, an in-process SQL OLAP Engine powered by ClickHouse
- [alyssaxuu/screenity](https://github.com/alyssaxuu/screenity) - The free and privacy-friendly screen recorder with no limits 🎥
- [matteoserva/GraphLLM](https://github.com/matteoserva/GraphLLM) - 
- [turboderp-org/exui](https://github.com/turboderp-org/exui) - Web UI for ExLlamaV2
...
- [irods-contrib/metalnx-web](https://github.com/irods-contrib/metalnx-web) - Metalnx Web GUI for iRODS
...
- [ibm-wm-transition/wm-is-client](https://github.com/ibm-wm-transition/wm-is-client) - Node.js package for invoking Integration Server services.
...
- [holepunchto/sodium-native](https://github.com/holepunchto/sodium-native) - Low level bindings for libsodium
...
- [EmbarkStudios/k8s-buildkite-plugin](https://github.com/EmbarkStudios/k8s-buildkite-plugin) - Run any buildkite build step as a Kubernetes Job
...
- [adinhodovic/kubernetes-autoscaling-mixin](https://github.com/adinhodovic/kubernetes-autoscaling-mixin) - Monitoring mixin for Kubernetes Autoscaling. A set of Grafana dashboards and Prometheus rules for Kubernetes Autoscaling.
...
- [marsauto/europilot](https://github.com/marsauto/europilot) - A toolkit for controlling Euro Truck Simulator 2 with the end-to-end driving model
...
- [headwindz/headwindz.me](https://github.com/headwindz/headwindz.me) - My personal blog
...
- [Lillecarl/easykubenix](https://github.com/Lillecarl/easykubenix) - Like kubenix, but easier
...
- [YPares/envil](https://github.com/YPares/envil) - envil forges Nix flakes and manages stacked environments
...
- [vsTerminus/SnowRunner](https://github.com/vsTerminus/SnowRunner) - Modifications to initial.pak for general improvements
...
- [platformbuilds/Akamai-ASN-and-IPs-List](https://github.com/platformbuilds/Akamai-ASN-and-IPs-List) - Hourly checked and updated IP Lists of Akamai Servers using the ASN Numbers from RADB Lookups
...
- [candiddev/etcha](https://github.com/candiddev/etcha) - Full-Stack Configuration Management for Developers and Sysadmins
...
- [openstack-archive/shade](https://github.com/openstack-archive/shade) - Client library for OpenStack containing Infra business logic. Mirror of code maintained at opendev.org.
...
- [BWLR/switches.mx](https://github.com/BWLR/switches.mx) - Open source code for the website https://switches.mx (currently lives on http://45.33.1.82/ until I get a new domain)
...
- [pramsey/pgsql-openai](https://github.com/pramsey/pgsql-openai) - Helper functions for working with the OpenAI API
- [ChuckHend/pg_timeseries](https://github.com/ChuckHend/pg_timeseries) - Simple and focused time-series tables for PostgreSQL
...
- [CrunchyData/pgmonitor-extension](https://github.com/CrunchyData/pgmonitor-extension) - 
...
- [jnidzwetzki/pg_plan_alternatives](https://github.com/jnidzwetzki/pg_plan_alternatives) - An eBPF based query planning tracer for PostgreSQL
...
- [aspectrr/fluid.sh](https://github.com/aspectrr/fluid.sh) - The AI Sys-Admin for Enterprise
...
- [thunlp/JustRL](https://github.com/thunlp/JustRL) - [ICLR 2026 Blogpost Track Poster] JustRL: Scaling a 1.5B LLM with a Simple RL Recipe
...
- [bitwire-it/ipblocklist](https://github.com/bitwire-it/ipblocklist) - IP list full of bad IPs - Updated every 2H
...
- [QKV-Core/QKV-Core](https://github.com/QKV-Core/QKV-Core) - "Adaptive Hybrid Quantization Framework for deploying 7B+ LLMs on low-VRAM devices (e.g., GTX 1050). Features surgical block alignment and Numba-accelerated inference.
...
- [Detrol/quorum-cli](https://github.com/Detrol/quorum-cli) - Multi-agent AI discussion CLI for structured debates between LLMs
...
- [antirez/freakwan](https://github.com/antirez/freakwan) - A floor-routing WAN implementing a chat over bare-LoRa (no LoRaWAN).
...
- [distil-labs/distil-gitara](https://github.com/distil-labs/distil-gitara) - GitAra 🦜🎸: A small function-calling git agent you can run locally
- [huggingface/trl](https://github.com/huggingface/trl) - Train transformer language models with reinforcement learning.
- [da-fr/Product-of-Experts-ARC-Paper](https://github.com/da-fr/Product-of-Experts-ARC-Paper) - Code for the ICML 2025 Paper "Product of Experts with LLMs: Boosting Performance on ARC is a Matter of Perspective"
- [ByteDance-Seed/seed-oss](https://github.com/ByteDance-Seed/seed-oss) - 
- [scylladb/vector-search-examples](https://github.com/scylladb/vector-search-examples) - Vector search examples with ScyllaDB
...
- [jerber/arc-lang-public](https://github.com/jerber/arc-lang-public) - 
...
- [tg12/congressional-filings-explorer](https://github.com/tg12/congressional-filings-explorer) - An intelligent pattern-matching tool for analyzing publicly available Congressional financial disclosure documents using AI-powered optical character recognition.
...
- [vmkspv/lenspect](https://github.com/vmkspv/lenspect) - A lightweight security threat scanner intended to make malware detection more accessible and efficient.
...
- [mitchins/FuzzyShell](https://github.com/mitchins/FuzzyShell) - Lightning fast smart search for your command history
- [gabber-dev/gabber](https://github.com/gabber-dev/gabber) - Build AI applications that can see, hear, and speak using your screens, microphones, and cameras as inputs.
...
- [ebiose-ai/ebiose](https://github.com/ebiose-ai/ebiose) - Ebiose is a distributed artificial intelligence factory, an open source project from the Inria’s incubator (French lab).
...
- [Kaizen-agent/kaizen-agent](https://github.com/Kaizen-agent/kaizen-agent) - The AI Agent That Improves Your LLM App
...
- [sundanc/flowstatecli](https://github.com/sundanc/flowstatecli) - command-line productivity tool for developers to track work sessions, manage tasks, and set goals,
- [magenta/magenta-realtime](https://github.com/magenta/magenta-realtime) - Magenta RealTime: An Open-Weights Live Music Model
- [magic-wormhole/fowl](https://github.com/magic-wormhole/fowl) - Forward over Wormhole: streams over magic-wormhole Dilation connections
- [magic-wormhole/magic-wormhole-transit-relay](https://github.com/magic-wormhole/magic-wormhole-transit-relay) - Transit Relay server for Magic-Wormhole
...
- [neural-maze/ava-whatsapp-agent-course](https://github.com/neural-maze/ava-whatsapp-agent-course) - Meet Ava, the WhatsApp Agent
...
- [AdnaneKhan/gato-x](https://github.com/AdnaneKhan/gato-x) - GitHub Attack Toolkit - Extreme Edition - A static analysis and exploit toolkit for GitHub Actions.
...
- [cloudcoil/cloudcoil](https://github.com/cloudcoil/cloudcoil) - Modern async-first Kubernetes client for Python with Pydantic models - bringing cloud-native operations and K8s development to life with elegant Pythonic APIs
...
- [rbignon/woob](https://github.com/rbignon/woob) - Web outside of Browsers
...
- [timo-reymann/mkdocs-decision-records](https://github.com/timo-reymann/mkdocs-decision-records) - Manage decision records with mkdocs in a customizable and minimal fashion.
...
- [lasconic/finary_uapi](https://github.com/lasconic/finary_uapi) - 
...
- [aws-controllers-k8s/lambda-controller](https://github.com/aws-controllers-k8s/lambda-controller) - ACK service controller for AWS Lambda
- [aws-controllers-k8s/ec2-controller](https://github.com/aws-controllers-k8s/ec2-controller) - ACK service controller for Amazon Elastic Compute Cloud (EC2)
...
- [AI-Hypercomputer/xpk](https://github.com/AI-Hypercomputer/xpk) - xpk (Accelerated Processing Kit, pronounced x-p-k,) is a software tool to help Cloud developers to orchestrate training jobs on accelerators such as TPUs and GPUs on GKE.
...
- [tahoe-lafs/zfec](https://github.com/tahoe-lafs/zfec) - zfec -- an efficient, portable erasure coding tool
...
- [mvdkleijn/ansible-maas](https://github.com/mvdkleijn/ansible-maas) - MIGRATED TO opencommit.eu -- Ansible Dynamic Inventory Script for Ubuntu MAAS 2.0 API
...
- [d2iq-archive/marathon-lb](https://github.com/d2iq-archive/marathon-lb) - Marathon-lb is a service discovery & load balancing tool for DC/OS
...
- [lance0/rustbgpd](https://github.com/lance0/rustbgpd) - An API-first BGP daemon in Rust for programmable route-server and control-plane use cases
...
- [Spooled-Cloud/spooled-backend](https://github.com/Spooled-Cloud/spooled-backend) - High-performance webhook queue and job scheduler for distributed systems.    10k+ jobs/sec with PostgreSQL, Redis, and WebSocket real-time updates.    Includes REST & gRPC APIs, multi-tenant isolation
...
- [pinkfuwa/llumen](https://github.com/pinkfuwa/llumen) - 🕯️ A lightweight but powerful LLM chat application
- [vosen/ZLUDA](https://github.com/vosen/ZLUDA) - CUDA on non-NVIDIA GPUs
- [EasyTier/EasyTier](https://github.com/EasyTier/EasyTier) - A simple, decentralized mesh VPN with WireGuard support.
- [surrealdb/surrealdb](https://github.com/surrealdb/surrealdb) - A scalable, distributed, collaborative, document-graph database, for the realtime web
- [graze-social/iftta](https://github.com/graze-social/iftta) - AT Protocol automation service written in Rust
- [chirpstack/chirpstack](https://github.com/chirpstack/chirpstack) - ChirpStack open-source LoRaWAN Network Server
...
- [deven96/ahnlich](https://github.com/deven96/ahnlich) - Suite of tools containing an in-memory vector datastore and AI proxy
- [unhappychoice/gitlogue](https://github.com/unhappychoice/gitlogue) - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
- [streamfold/rotel](https://github.com/streamfold/rotel) - High Performance, Resource Efficient OpenTelemetry Collection
...
- [allenai/duplodocus](https://github.com/allenai/duplodocus) - Tooling for exact and MinHash deduplication of large-scale text datasets
...
- [jsnli/Samira](https://github.com/jsnli/Samira) - Steam Achievement Manager for Linux. Created with Tauri and Rust.
...
- [wasmCloud/wadm-operator](https://github.com/wasmCloud/wadm-operator) - Kubernetes operator for declaratively deploying wasmCloud applications (via wadm) and hosts on Kubernetes.
...
- [denoland/sui](https://github.com/denoland/sui) - Embed custom RO data into precompiled executables
...
- [veepee-oss/terustry](https://github.com/veepee-oss/terustry) - Open Source terraform provider registry
...
- [acrlabs/simkube](https://github.com/acrlabs/simkube) - Record-and-replay Kubernetes simulator based on KWOK
...
- [bnkc/emval](https://github.com/bnkc/emval) - emval is a blazingly fast email validator.
...
- [datastax-archive/kaskada](https://github.com/datastax-archive/kaskada) - Modern, open-source event-processing
...
- [joknarf/thefly](https://github.com/joknarf/thefly) - shell teleporter plugin/dotfiles manager (bash/zsh/ksh/fish)
...
- [KolosalAI/model-memory-calculator](https://github.com/KolosalAI/model-memory-calculator) - Simple model memory requirements calculator for GGUF
...
- [estrattonbailey/slipstream](https://github.com/estrattonbailey/slipstream) - Slipstream is a syncing and ingestion pipeline for atproto, built on Cloudflare.
- [ridafkih/keeper.sh](https://github.com/ridafkih/keeper.sh) - Open-source calendar sync tool & universal calendar MCP server. Aggregate, sync and control calendars on Google, Outlook, Office 365, iCloud, CalDAV or ICS.
...
- [dynamik-dev/refdoc-cli](https://github.com/dynamik-dev/refdoc-cli) - 
...
- [mikelane/git-rewind](https://github.com/mikelane/git-rewind) - A privacy-focused year-in-review for your GitHub activity
...
- [renderghost/lanyards](https://github.com/renderghost/lanyards) - Lanyards is a dedicated profile for researchers, built on the AT Protocol
...
- [ing-norante/unmarker.it](https://github.com/ing-norante/unmarker.it) - A 100% client-side AI watermark disruptor. Process images entirely in your browser with no uploads, no tracking, and no servers.
...
- [zabbly/incus-ui-canonical](https://github.com/zabbly/incus-ui-canonical) - Fork of canonical/lxd-ui for use with Incus (gets rebased frequently)
...
- [agentcommunity/agent-identity-discovery](https://github.com/agentcommunity/agent-identity-discovery) - Agent Interface Discovery
...
- [freelensapp/freelens-fluxcd-extension](https://github.com/freelensapp/freelens-fluxcd-extension) - Freelens FluxCD extension
...
- [muni-town/roomy](https://github.com/muni-town/roomy) - Gardenable group chats in the Atmosphere.
...
- [brave/brave-talk](https://github.com/brave/brave-talk) - Unlimited private video calls with your friends and colleagues
...
- [valyentdev/valyent](https://github.com/valyentdev/valyent) - Deploy Docker containers at scale with Valyent.
...
- [MattKetmo/radar](https://github.com/MattKetmo/radar) - Alert dashboard for Prometheus Alertmanager
...
- [drobertson-dev/nuxt-shadcn-prisma-auth](https://github.com/drobertson-dev/nuxt-shadcn-prisma-auth) - A production-ready Nuxt 4 starter template with authentication, database, and modern UI — designed for both human developers and AI coding agents.
...
- [sebbkw/forum](https://github.com/sebbkw/forum) - Forum software created using Express, Vue, and Sequelize
