...
- [analytics](https://github.com/plausible/analytics) (27256 stars) - Open source, privacy-first web analytics. Lightweight, cookie-free Google Analytics alternative. Self-hosted or cloud.
...
- [phoenix_live_view](https://github.com/phoenixframework/phoenix_live_view) (6770 stars) - Rich, real-time user experiences with server-rendered HTML
...
- [supavisor](https://github.com/supabase/supavisor) (2222 stars) - A cloud-native, multi-tenant Postgres connection pooler.
