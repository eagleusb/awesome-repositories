...
- [opengrep](https://github.com/opengrep/opengrep) (3015 stars) - 🔎 Static code analysis engine to find security issues in code.
...
- [semgrep](https://github.com/semgrep/semgrep) (16457 stars) - Lightweight static analysis for many languages. Find bug variants with patterns that look like source code.
- [stategraph](https://github.com/stategraph/stategraph) (1276 stars) - Terraform without the state file bottleneck
- [unison](https://github.com/bcpierce00/unison) (5456 stars) - Unison file synchronizer
