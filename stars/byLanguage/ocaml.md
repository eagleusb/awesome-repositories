...
- [liquidsoap](https://github.com/savonet/liquidsoap) (1730 stars) - Liquidsoap is a statically typed scripting general-purpose language with dedicated operators and backend for all thing media, streaming, file generation, automation, HTTP backend and more.
- [mirage](https://github.com/mirage/mirage) (2988 stars) - MirageOS is a library operating system that constructs unikernels
- [opengrep](https://github.com/opengrep/opengrep) (3069 stars) - 🔎 Static code analysis engine to find security issues in code.
