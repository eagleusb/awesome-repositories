...
- [semgrep](https://github.com/semgrep/semgrep) (16072 stars) - Lightweight static analysis for many languages. Find bug variants with patterns that look like source code.
- [terrateam](https://github.com/terrateamio/terrateam) (1251 stars) - Terrateam is open-source GitOps infrastructure orchestration. It integrates with GitHub to automate Terraform, OpenTofu, CDKTF, Terragrunt, and Pulumi workflows through pull requests.
