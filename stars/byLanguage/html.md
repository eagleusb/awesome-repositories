...
- [alpine](https://github.com/alpinejs/alpine) (31613 stars) - A rugged, minimal framework for composing JavaScript behavior in your markup. 
- [awesome-ai-web-search](https://github.com/felladrin/awesome-ai-web-search) (1321 stars) - List of software that allows searching the web with the assistance of AI: https://hf.co/spaces/felladrin/awesome-ai-web-search
- [awesome-generative-ai-guide](https://github.com/aishwaryanr/awesome-generative-ai-guide) (26868 stars) - A one stop repository for generative AI research updates, interview resources, notebooks and much more!
...
- [computer-science](https://github.com/ossu/computer-science) (204185 stars) - 🎓 Path to a free self-taught education in Computer Science!
...
- [easyeffects](https://github.com/wwmm/easyeffects) (9542 stars) - Limiter, compressor, convolver, equalizer and auto volume and many other plugins for PipeWire applications
...
- [free-for-dev](https://github.com/ripienaar/free-for-dev) (122704 stars) - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
- [keeweb](https://github.com/keeweb/keeweb) (12929 stars) - Free cross-platform password manager compatible with KeePass
...
- [pdfs](https://github.com/tpn/pdfs) (9763 stars) - Technically-oriented PDF Collection (Papers, Specs, Decks, Manuals, etc)
- [plural](https://github.com/pluralsh/plural) (1486 stars) - Enterprise Kubernetes management, accelerated. 🚀
- [public-pentesting-reports](https://github.com/juliocesarfort/public-pentesting-reports) (9560 stars) - A list of public penetration test reports published by several consulting firms and academic security groups.
...
- [SONiC](https://github.com/sonic-net/SONiC) (2812 stars) - Landing page for Software for Open Networking in the Cloud (SONiC) - https://sonic-net.github.io/SONiC/
...
- [tools](https://github.com/standardebooks/tools) (1647 stars) - The Standard Ebooks toolset for producing our ebook files.
- [web-starter-kit](https://github.com/google/web-starter-kit) (18306 stars) - Web Starter Kit - a workflow for multi-device websites
- [website](https://github.com/kubernetes/website) (5242 stars) - Kubernetes website and documentation repo: 
- [windmill](https://github.com/windmill-labs/windmill) (16589 stars) - Open-source developer platform to power your entire infra and turn scripts into webhooks, workflows and UIs. Fastest workflow engine (13x vs Airflow). Open-source alternative to Retool and Temporal.
