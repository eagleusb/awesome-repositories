...
- [awesome-ai-web-search](https://github.com/felladrin/awesome-ai-web-search) (1327 stars) - List of software that allows searching the web with the assistance of AI: https://hf.co/spaces/felladrin/awesome-ai-web-search
- [awesome-generative-ai-guide](https://github.com/aishwaryanr/awesome-generative-ai-guide) (26907 stars) - A one stop repository for generative AI research updates, interview resources, notebooks and much more!
...
- [computer-science](https://github.com/ossu/computer-science) (204282 stars) - 🎓 Path to a free self-taught education in Computer Science!
...
- [docs](https://github.com/knative/docs) (5048 stars) - User documentation for Knative components.
...
- [easyeffects](https://github.com/wwmm/easyeffects) (9551 stars) - Limiter, compressor, convolver, equalizer and auto volume and many other plugins for PipeWire applications
...
- [free-for-dev](https://github.com/ripienaar/free-for-dev) (122784 stars) - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
- [kubernetes-goat](https://github.com/madhuakula/kubernetes-goat) (5656 stars) - Kubernetes Goat is a "Vulnerable by Design" cluster environment to learn and practice Kubernetes security using an interactive hands-on playground 🚀
...
- [pdfs](https://github.com/tpn/pdfs) (9762 stars) - Technically-oriented PDF Collection (Papers, Specs, Decks, Manuals, etc)
...
- [recipes](https://github.com/TandoorRecipes/recipes) (8365 stars) - Application for managing recipes, planning meals, building shopping lists and much much more!
...
- [windmill](https://github.com/windmill-labs/windmill) (16604 stars) - Open-source developer platform to power your entire infra and turn scripts into webhooks, workflows and UIs. Fastest workflow engine (13x vs Airflow). Open-source alternative to Retool and Temporal.
- [zoraxy](https://github.com/tobychui/zoraxy) (5195 stars) - A general purpose HTTP reverse proxy and forwarding tool. Now written in Go!
