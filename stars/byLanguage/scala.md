...
- [gatling](https://github.com/gatling/gatling) (6904 stars) - Modern Load Testing as Code
...
- [scylla-migrator](https://github.com/scylladb/scylla-migrator) (72 stars) - Migrate data extract using Spark to Scylla, normally from Cassandra/parquet files. Alt. from DynamoDB to Scylla Alternator.
