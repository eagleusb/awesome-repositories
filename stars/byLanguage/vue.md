## Vue (15 repositories) 
- [automa](https://github.com/AutomaApp/automa) (21187 stars) - A browser extension for automating your browser by connecting blocks
...
- [Sink](https://github.com/miantiao-me/Sink) (6467 stars) - ⚡ A Simple / Speedy / Secure Link Shortener with Analytics, 100% run on Cloudflare.
...
- [tiny-rdm](https://github.com/tiny-craft/tiny-rdm) (12649 stars) - Tiny RDM (Tiny Redis Desktop Manager) - A modern, colorful, super lightweight Redis GUI client for Mac, Windows, and Linux. It also provides a web version that can be deployed via Docker.
...
- [xray](https://github.com/chaitin/xray) (11475 stars) - 一款长亭自研的完善的安全评估工具，支持常见 web 安全问题扫描和自定义 poc | 使用之前务必先阅读文档
