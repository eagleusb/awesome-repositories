...
- [pg_column_tetris](https://github.com/rogerwelin/pg_column_tetris) (56 stars) - A PostgreSQL extension that can enforce optimal column alignment to minimize row padding waste.
- [pg_partman](https://github.com/pgpartman/pg_partman) (2704 stars) - Partition management extension for PostgreSQL
...
- [pgmq](https://github.com/pgmq/pgmq) (4851 stars) - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
...
- [zombodb](https://github.com/zombodb/zombodb) (4733 stars) - Making Postgres and Elasticsearch work together like it's 2023
