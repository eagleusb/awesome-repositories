...
- [openmaptiles](https://github.com/openmaptiles/openmaptiles) (3068 stars) - OpenMapTiles Vector Tile Schema Implementation
...
- [pg_column_tetris](https://github.com/rogerwelin/pg_column_tetris) (51 stars) - A PostgreSQL extension that can enforce optimal column alignment to minimize row padding waste.
- [pg_partman](https://github.com/pgpartman/pg_partman) (2702 stars) - Partition management extension for PostgreSQL
...
- [pgmq](https://github.com/pgmq/pgmq) (4847 stars) - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
- [pgsql-openai](https://github.com/pramsey/pgsql-openai) (54 stars) - Helper functions for working with the OpenAI API
- [postgis](https://github.com/postgis/postgis) (2116 stars) - PostGIS spatial database extension to PostgreSQL [mirror]
