...
- [Audax-Data-Manager](https://github.com/commandprompt/Audax-Data-Manager) (1034 stars) - Web tool for database management
- [openmaptiles](https://github.com/openmaptiles/openmaptiles) (3154 stars) - OpenMapTiles Vector Tile Schema Implementation
...
- [pg_durable](https://github.com/microsoft/pg_durable) (2805 stars) - PostgreSQL in-database durable execution
- [pg_partman](https://github.com/pgpartman/pg_partman) (2813 stars) - Partition management extension for PostgreSQL
...
- [pgai](https://github.com/timescale/pgai) (5807 stars) - A suite of tools to develop RAG, semantic search, and other AI applications more easily with PostgreSQL
- [pgedge-vectorizer](https://github.com/pgEdge/pgedge-vectorizer) (37 stars) - A PostgreSQL extension to create chunk tables for existing text data, and populate them with embeddings using your favourite LLM.
...
- [postgis](https://github.com/postgis/postgis) (2223 stars) - PostGIS spatial database extension to PostgreSQL [mirror]
