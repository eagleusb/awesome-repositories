...
- [openmaptiles](https://github.com/openmaptiles/openmaptiles) (3161 stars) - OpenMapTiles Vector Tile Schema Implementation
- [pg-trickle](https://github.com/trickle-labs/pg-trickle) (142 stars) - A PostgreSQL 18+ extension for streaming tables with incremental view maintenance, powered by differential dataflow in Rust.
...
- [pg_partman](https://github.com/pgpartman/pg_partman) (2822 stars) - Partition management extension for PostgreSQL
...
- [pgedge-vectorizer](https://github.com/pgEdge/pgedge-vectorizer) (39 stars) - A PostgreSQL extension to create chunk tables for existing text data, and populate them with embeddings using your favourite LLM.
...
- [postgis](https://github.com/postgis/postgis) (2228 stars) - PostGIS spatial database extension to PostgreSQL [mirror]
