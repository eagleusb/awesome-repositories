...
- [apisix](https://github.com/apache/apisix) (16955 stars) - The Cloud-Native API Gateway and AI Gateway
...
- [kong](https://github.com/Kong/kong) (43918 stars) - 🦍 The API and AI Gateway
- [LazyVim](https://github.com/LazyVim/LazyVim) (27087 stars) - Neovim config for the lazy
- [lite](https://github.com/rxi/lite) (8207 stars) - A lightweight text editor written in Lua
...
- [lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) (8082 stars) - A blazing fast and easy to configure neovim statusline plugin written in pure lua.
- [ntopng](https://github.com/ntop/ntopng) (8062 stars) - Web-based Traffic and Cybersecurity Network Traffic Monitoring
...
- [tarantool](https://github.com/tarantool/tarantool) (3658 stars) - Get your data in RAM. Get compute close to data. Enjoy the performance.
- [tl](https://github.com/teal-language/tl) (2798 stars) - The compiler for Teal, a typed dialect of Lua
