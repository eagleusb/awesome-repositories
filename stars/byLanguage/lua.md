...
- [apisix](https://github.com/apache/apisix) (16787 stars) - The Cloud-Native API Gateway and AI Gateway
- [AstroNvim](https://github.com/AstroNvim/AstroNvim) (14360 stars) - AstroNvim is an aesthetic and feature-rich neovim config that is extensible and easy to use with a great set of plugins 
...
- [kong](https://github.com/Kong/kong) (43691 stars) - 🦍 The API and AI Gateway
- [LazyVim](https://github.com/LazyVim/LazyVim) (26751 stars) - Neovim config for the lazy
- [lite](https://github.com/rxi/lite) (8190 stars) - A lightweight text editor written in Lua
...
- [ntopng](https://github.com/ntop/ntopng) (7900 stars) - Web-based Traffic and Security Network Traffic Monitoring
...
- [tl](https://github.com/teal-language/tl) (2768 stars) - The compiler for Teal, a typed dialect of Lua
