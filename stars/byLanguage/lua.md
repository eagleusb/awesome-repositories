...
- [apisix](https://github.com/apache/apisix) (16338 stars) - The Cloud-Native API Gateway and AI Gateway
- [AstroNvim](https://github.com/AstroNvim/AstroNvim) (14205 stars) - AstroNvim is an aesthetic and feature-rich neovim config that is extensible and easy to use with a great set of plugins 
- [awesome](https://github.com/awesomeWM/awesome) (6842 stars) - awesome window manager
...
- [kong](https://github.com/Kong/kong) (43014 stars) - 🦍 The API and AI Gateway
- [LazyVim](https://github.com/LazyVim/LazyVim) (25513 stars) - Neovim config for the lazy
...
- [lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) (7811 stars) - A blazing fast and easy to configure neovim statusline plugin written in pure lua.
- [moonscript](https://github.com/leafo/moonscript) (3420 stars) - :crescent_moon: A language that compiles to Lua
- [ntopng](https://github.com/ntop/ntopng) (7627 stars) - Web-based Traffic and Security Network Traffic Monitoring
