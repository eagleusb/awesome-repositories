...
- [A2A](https://github.com/a2aproject/A2A) (25322 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3094 stars) - The Best GUI for Milvus
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21252 stars) - Collections of awesome neovim plugins.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6190 stars) - Lightweight justice for your single-board computer!
...
- [dokku](https://github.com/dokku/dokku) (32104 stars) - A docker-powered PaaS that helps you build and manage the lifecycle of applications
...
- [fallout-grub-theme](https://github.com/shvchk/fallout-grub-theme) (1049 stars) - Fallout GRUB theme
...
- [ghostty-ubuntu](https://github.com/mkasberg/ghostty-ubuntu) (1226 stars) - Ubuntu/Debian (.deb) packages for Ghostty
...
- [git-secrets](https://github.com/awslabs/git-secrets) (13369 stars) - Prevents you from committing secrets and credentials into git repositories
...
- [gitflow](https://github.com/nvie/gitflow) (26809 stars) - Git extensions to provide high-level repository operations for Vincent Driessen's branching model.
...
- [Hack](https://github.com/source-foundry/Hack) (17316 stars) - A typeface designed for source code
...
- [JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) (12955 stars) - JetBrains Mono – the free and open-source typeface for developers
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4215 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4024 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7913 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19552 stars) - An innovative superfamily of fonts for code
...
- [orbstack](https://github.com/orbstack/orbstack) (9180 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1266 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12550 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108699 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8001 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (60331 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5521 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [pure-bash-bible](https://github.com/dylanaraps/pure-bash-bible) (41722 stars) - 📖 A collection of pure bash alternatives to external processes.
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9498 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/cloudflare/skills) (2618 stars) - Skills for teaching agents how to build on Cloudflare.
- [skills](https://github.com/mattpocock/skills) (215266 stars) - Skills for Real Engineers. Straight from my .agents directory.
...
- [superpowers](https://github.com/obra/superpowers) (271312 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3823 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13074 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [uusec-waf](https://github.com/Safe3/uusec-waf) (1700 stars) - Industry-leading free, high-performance, AI and semantic technology Web Application Firewall and API Security Gateway (WAAP) - UUSEC WAF.
...
- [vscodium](https://github.com/VSCodium/vscodium) (32799 stars) - binary releases of VS Code without MS branding/telemetry/licensing
