...
- [A2A](https://github.com/a2aproject/A2A) (25301 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3092 stars) - The Best GUI for Milvus
- [aviary.sh](https://github.com/frameable/aviary.sh) (1308 stars) - Minimal distributed configuration management in bash
- [Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) (5913 stars) - An awesome & curated list of best LLMOps tools for developers
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21248 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15139 stars) - A community Bash framework.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6188 stars) - Lightweight justice for your single-board computer!
...
- [docker-github-actions-runner](https://github.com/myoung34/docker-github-actions-runner) (2408 stars) - This will run the new self-hosted github actions runners with docker-in-docker
...
- [ghostty-ubuntu](https://github.com/mkasberg/ghostty-ubuntu) (1225 stars) - Ubuntu/Debian (.deb) packages for Ghostty
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10286 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS.
- [gogo-release](https://github.com/arp242/gogo-release) (32 stars) - Build cross-platform binaries for Go
- [Hack](https://github.com/source-foundry/Hack) (17314 stars) - A typeface designed for source code
...
- [imapsync](https://github.com/imapsync/imapsync) (4122 stars) - Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is 
- [jboss-autopwn](https://github.com/SpiderLabs/jboss-autopwn) (177 stars) - A JBoss script for obtaining remote shell access
- [JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) (12947 stars) - JetBrains Mono – the free and open-source typeface for developers
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4209 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4017 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19547 stars) - An innovative superfamily of fonts for code
...
- [nginx-admins-handbook](https://github.com/trimstray/nginx-admins-handbook) (14300 stars) - How to improve NGINX performance, security, and other important things.
...
- [orbstack](https://github.com/orbstack/orbstack) (9175 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1265 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12546 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108671 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (7999 stars) - Pixel perfect icon theme for Linux
- [pds](https://github.com/bluesky-social/pds) (2600 stars) - Bluesky PDS (Personal Data Server) container image, compose file, and documentation
- [pi-hole](https://github.com/pi-hole/pi-hole) (60312 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5518 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 500+ PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9495 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/cloudflare/skills) (2609 stars) - Skills for teaching agents how to build on Cloudflare.
- [skills](https://github.com/mattpocock/skills) (213977 stars) - Skills for Real Engineers. Straight from my .agents directory.
...
- [super-linter](https://github.com/super-linter/super-linter) (10542 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (270811 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3822 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13073 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [try](https://github.com/binpash/try) (5485 stars) - Inspect, control, and manipulate a command's effects before modifying your live system.
...
- [vscodium](https://github.com/VSCodium/vscodium) (32786 stars) - binary releases of VS Code without MS branding/telemetry/licensing
