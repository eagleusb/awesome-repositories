...
- [A2A](https://github.com/a2aproject/A2A) (25898 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3171 stars) - The Best GUI for Milvus
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21412 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15238 stars) - A community Bash framework.
...
- [claude-desktop-debian](https://github.com/aaddrick/claude-desktop-debian) (5403 stars) - Claude Desktop for Linux
...
- [DietPi](https://github.com/MichaIng/DietPi) (6283 stars) - Lightweight justice for your single-board computer!
...
- [git-extras](https://github.com/tj/git-extras) (18109 stars) - GIT utilities -- repo summary, repl, changelog population, author commit percentages and more
...
- [git-sync](https://github.com/kubernetes/git-sync) (2737 stars) - A sidecar app which clones a git repo and keeps it in sync with the upstream.
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4492 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4630 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7998 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19659 stars) - An innovative superfamily of fonts for code
...
- [orbstack](https://github.com/orbstack/orbstack) (9354 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1289 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12664 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (109933 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8100 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (61023 stars) - A black hole for Internet advertisements
...
- [pure-bash-bible](https://github.com/dylanaraps/pure-bash-bible) (41712 stars) - 📖 A collection of pure bash alternatives to external processes.
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9582 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (267976 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2895 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [superpowers](https://github.com/obra/superpowers) (290287 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3881 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13127 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [vscodium](https://github.com/VSCodium/vscodium) (33345 stars) - binary releases of VS Code without MS branding/telemetry/licensing
