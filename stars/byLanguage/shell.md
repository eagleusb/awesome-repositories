...
- [A2A](https://github.com/a2aproject/A2A) (25368 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3104 stars) - The Best GUI for Milvus
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21271 stars) - Collections of awesome neovim plugins.
...
- [bluefin](https://github.com/ublue-os/bluefin) (2566 stars) - The next generation Linux workstation, designed for reliability, performance, and sustainability.
- [build](https://github.com/armbian/build) (5353 stars) - The official build framework for the Armbian Linux distribution. This repository contains the complete toolchain and scripts required to compile custom OS images from source, including kernel configuration, U-Boot handling, and board-specific tweaks for various ARM and ARM64 single-board computers.
- [build-linux](https://github.com/MichielDerhaeg/build-linux) (5198 stars) - A short tutorial about building Linux based operating systems.
...
- [docker-bench-security](https://github.com/docker/docker-bench-security) (9689 stars) - The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
...
- [dokku](https://github.com/dokku/dokku) (32098 stars) - A docker-powered PaaS that helps you build and manage the lifecycle of applications
...
- [git-secrets](https://github.com/awslabs/git-secrets) (13373 stars) - Prevents you from committing secrets and credentials into git repositories
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10291 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS.
- [gogo-release](https://github.com/arp242/gogo-release) (32 stars) - Build cross-platform binaries for Go
- [Hack](https://github.com/source-foundry/Hack) (17325 stars) - A typeface designed for source code
...
- [JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) (12970 stars) - JetBrains Mono – the free and open-source typeface for developers
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4242 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4039 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7916 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19556 stars) - An innovative superfamily of fonts for code
...
- [nginx-admins-handbook](https://github.com/trimstray/nginx-admins-handbook) (14303 stars) - How to improve NGINX performance, security, and other important things.
...
- [orbstack](https://github.com/orbstack/orbstack) (9197 stars) - Fast, light, simple Docker containers & Linux machines
...
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108788 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8016 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (60409 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5538 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9501 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (219358 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2652 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [super-linter](https://github.com/super-linter/super-linter) (10546 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (272834 stars) - An agentic skills framework & software development methodology that works.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13077 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [transcrypt](https://github.com/elasticdog/transcrypt) (1704 stars) - transparently encrypt files within a git repository
...
- [vscodium](https://github.com/VSCodium/vscodium) (32847 stars) - binary releases of VS Code without MS branding/telemetry/licensing
