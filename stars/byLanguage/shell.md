...
- [A2A](https://github.com/a2aproject/A2A) (25885 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3169 stars) - The Best GUI for Milvus
- [aviary.sh](https://github.com/frameable/aviary.sh) (1310 stars) - Minimal distributed configuration management in bash
- [Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) (5944 stars) - An awesome & curated list of best LLMOps tools for developers
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21406 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15229 stars) - A community Bash framework.
...
- [bluefin](https://github.com/ublue-os/bluefin) (2602 stars) - The next generation Linux workstation, designed for reliability, performance, and sustainability.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6280 stars) - Lightweight justice for your single-board computer!
...
- [git-extras](https://github.com/tj/git-extras) (18108 stars) - GIT utilities -- repo summary, repl, changelog population, author commit percentages and more
...
- [git-secrets](https://github.com/awslabs/git-secrets) (13402 stars) - Prevents you from committing secrets and credentials into git repositories
...
- [Hack](https://github.com/source-foundry/Hack) (17352 stars) - A typeface designed for source code
...
- [imapsync](https://github.com/imapsync/imapsync) (4161 stars) - Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is 
...
- [kube-ps1](https://github.com/jonmosco/kube-ps1) (3813 stars) - Kubernetes prompt info for bash, fish, and zsh
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4486 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4614 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7996 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19655 stars) - An innovative superfamily of fonts for code
...
- [orbstack](https://github.com/orbstack/orbstack) (9351 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1288 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12661 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (109913 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8098 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (61014 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5663 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [sbc-bench](https://github.com/ThomasKaiser/sbc-bench) (767 stars) - Simple benchmark for single board computers
- [self-hosted](https://github.com/getsentry/self-hosted) (9581 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/cloudflare/skills) (2889 stars) - Skills for teaching agents how to build on Cloudflare.
- [skills](https://github.com/mattpocock/skills) (267297 stars) - Skills for Real Engineers. Straight from my .agents directory.
...
- [super-linter](https://github.com/super-linter/super-linter) (10602 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (289807 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3880 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13125 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [vscodium](https://github.com/VSCodium/vscodium) (33332 stars) - binary releases of VS Code without MS branding/telemetry/licensing
