...
- [A2A](https://github.com/a2aproject/A2A) (25381 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3106 stars) - The Best GUI for Milvus
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21277 stars) - Collections of awesome neovim plugins.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6194 stars) - Lightweight justice for your single-board computer!
...
- [dokku](https://github.com/dokku/dokku) (32100 stars) - A docker-powered PaaS that helps you build and manage the lifecycle of applications
...
- [git-secrets](https://github.com/awslabs/git-secrets) (13375 stars) - Prevents you from committing secrets and credentials into git repositories
...
- [gitflow](https://github.com/nvie/gitflow) (26802 stars) - Git extensions to provide high-level repository operations for Vincent Driessen's branching model.
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10293 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS.
...
- [helm-secrets](https://github.com/jkroepke/helm-secrets) (2024 stars) - A helm plugin that help manage secrets with Git workflow and store them anywhere
...
- [JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) (12974 stars) - JetBrains Mono – the free and open-source typeface for developers
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4245 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4047 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
...
- [orbstack](https://github.com/orbstack/orbstack) (9203 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1269 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12565 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108802 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8017 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (60426 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5544 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9502 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/cloudflare/skills) (2660 stars) - Skills for teaching agents how to build on Cloudflare.
- [skills](https://github.com/mattpocock/skills) (220414 stars) - Skills for Real Engineers. Straight from my .agents directory.
...
- [super-linter](https://github.com/super-linter/super-linter) (10548 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (273242 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3828 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [uusec-waf](https://github.com/Safe3/uusec-waf) (1702 stars) - Industry-leading free, high-performance, AI and semantic technology Web Application Firewall and API Security Gateway (WAAP) - UUSEC WAF.
...
- [vscodium](https://github.com/VSCodium/vscodium) (32858 stars) - binary releases of VS Code without MS branding/telemetry/licensing
