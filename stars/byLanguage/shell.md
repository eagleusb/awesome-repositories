...
- [A2A](https://github.com/a2aproject/A2A) (25424 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3109 stars) - The Best GUI for Milvus
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21289 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15142 stars) - A community Bash framework.
...
- [bluefin](https://github.com/ublue-os/bluefin) (2571 stars) - The next generation Linux workstation, designed for reliability, performance, and sustainability.
- [build](https://github.com/armbian/build) (5360 stars) - The official build framework for the Armbian Linux distribution. This repository contains the complete toolchain and scripts required to compile custom OS images from source, including kernel configuration, U-Boot handling, and board-specific tweaks for various ARM and ARM64 single-board computers.
- [build-linux](https://github.com/MichielDerhaeg/build-linux) (5196 stars) - A short tutorial about building Linux based operating systems.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6198 stars) - Lightweight justice for your single-board computer!
...
- [docker-bench-security](https://github.com/docker/docker-bench-security) (9692 stars) - The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
...
- [ghostty-ubuntu](https://github.com/mkasberg/ghostty-ubuntu) (1230 stars) - Ubuntu/Debian (.deb) packages for Ghostty
...
- [git-secret](https://github.com/sobolevn/git-secret) (4036 stars) - :busts_in_silhouette: A bash-tool to store your private data inside a git repository.
- [git-secrets](https://github.com/awslabs/git-secrets) (13377 stars) - Prevents you from committing secrets and credentials into git repositories
...
- [gitflow](https://github.com/nvie/gitflow) (26797 stars) - Git extensions to provide high-level repository operations for Vincent Driessen's branching model.
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10292 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS.
...
- [imapsync](https://github.com/imapsync/imapsync) (4125 stars) - Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is 
- [jboss-autopwn](https://github.com/SpiderLabs/jboss-autopwn) (177 stars) - A JBoss script for obtaining remote shell access
- [JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) (12980 stars) - JetBrains Mono – the free and open-source typeface for developers
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4272 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4068 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7920 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19565 stars) - An innovative superfamily of fonts for code
...
- [orbstack](https://github.com/orbstack/orbstack) (9212 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1271 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12571 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108851 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8024 stars) - Pixel perfect icon theme for Linux
- [pds](https://github.com/bluesky-social/pds) (2604 stars) - Bluesky PDS (Personal Data Server) container image, compose file, and documentation
- [pi-hole](https://github.com/pi-hole/pi-hole) (60489 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5554 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9505 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (223910 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2673 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [steam-runtime](https://github.com/ValveSoftware/steam-runtime) (1441 stars) - A runtime environment for Steam applications
- [super-linter](https://github.com/super-linter/super-linter) (10551 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (274317 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3832 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13081 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [transcrypt](https://github.com/elasticdog/transcrypt) (1705 stars) - transparently encrypt files within a git repository
...
- [UserLAnd](https://github.com/CypherpunkArmory/UserLAnd) (4260 stars) - Main UserLAnd Repository
...
- [vscodium](https://github.com/VSCodium/vscodium) (32892 stars) - binary releases of VS Code without MS branding/telemetry/licensing
