...
- [A2A](https://github.com/a2aproject/A2A) (25912 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3175 stars) - The Best GUI for Milvus
- [aviary.sh](https://github.com/frameable/aviary.sh) (1310 stars) - Minimal distributed configuration management in bash
- [Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) (5945 stars) - An awesome & curated list of best LLMOps tools for developers
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21413 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15245 stars) - A community Bash framework.
...
- [bluefin](https://github.com/ublue-os/bluefin) (2604 stars) - The next generation Linux workstation, designed for reliability, performance, and sustainability.
- [build](https://github.com/armbian/build) (5441 stars) - The official build framework for the Armbian Linux distribution. This repository contains the complete toolchain and scripts required to compile custom OS images from source, including kernel configuration, U-Boot handling, and board-specific tweaks for various ARM and ARM64 single-board computers.
- [build-linux](https://github.com/MichielDerhaeg/build-linux) (5199 stars) - A short tutorial about building Linux based operating systems.
...
- [claude-desktop-debian](https://github.com/aaddrick/claude-desktop-debian) (5400 stars) - Claude Desktop for Linux
...
- [containers-roadmap](https://github.com/aws/containers-roadmap) (5362 stars) - This is the public roadmap for AWS container services (ECS, ECR, Fargate, and EKS). 
...
- [DietPi](https://github.com/MichaIng/DietPi) (6291 stars) - Lightweight justice for your single-board computer!
...
- [docker-bench-security](https://github.com/docker/docker-bench-security) (9699 stars) - The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
- [docker-k8s-lab](https://github.com/xiaopeng163/docker-k8s-lab) (211 stars) - docker and kubernetes lab
- [docs](https://github.com/docker-library/docs) (5292 stars) - Documentation for Docker Official Images in docker-library
...
- [extra-container](https://github.com/erikarvstedt/extra-container) (301 stars) - Run declarative NixOS containers without full system rebuilds
- [fallout-grub-theme](https://github.com/shvchk/fallout-grub-theme) (1071 stars) - Fallout GRUB theme
...
- [git-extras](https://github.com/tj/git-extras) (18111 stars) - GIT utilities -- repo summary, repl, changelog population, author commit percentages and more
- [git-secret](https://github.com/sobolevn/git-secret) (4046 stars) - :busts_in_silhouette: A bash-tool to store your private data inside a git repository.
- [git-secrets](https://github.com/awslabs/git-secrets) (13404 stars) - Prevents you from committing secrets and credentials into git repositories
- [git-sync](https://github.com/kubernetes/git-sync) (2738 stars) - A sidecar app which clones a git repo and keeps it in sync with the upstream.
- [gitflow](https://github.com/nvie/gitflow) (26782 stars) - Git extensions to provide high-level repository operations for Vincent Driessen's branching model.
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10318 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS. (https://gogh-co.github.io/Gogh/)
- [gogo-release](https://github.com/arp242/gogo-release) (32 stars) - Build cross-platform binaries for Go
- [Hack](https://github.com/source-foundry/Hack) (17353 stars) - A typeface designed for source code
...
- [helm-secrets](https://github.com/jkroepke/helm-secrets) (2030 stars) - A helm plugin that help manage secrets with Git workflow and store them anywhere
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4496 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4646 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (8001 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19662 stars) - An innovative superfamily of fonts for code
...
- [nginx-admins-handbook](https://github.com/trimstray/nginx-admins-handbook) (14310 stars) - How to improve NGINX performance, security, and other important things.
...
- [oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) (11393 stars) - The Fish Shell Framework
- [open-balena](https://github.com/balena-io/open-balena) (1273 stars) - Open source software to manage connected IoT devices at scale
...
- [orbstack](https://github.com/orbstack/orbstack) (9355 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1292 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12667 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (109957 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8103 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (61046 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5668 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [pure-bash-bible](https://github.com/dylanaraps/pure-bash-bible) (41713 stars) - 📖 A collection of pure bash alternatives to external processes.
- [pussh](https://github.com/bearstech/pussh) (266 stars) - Parallel SSH, batch and command line oriented
- [raspotify](https://github.com/dtcooper/raspotify) (5210 stars) - A Spotify Connect client that mostly Just Works™
...
- [sbc-bench](https://github.com/ThomasKaiser/sbc-bench) (768 stars) - Simple benchmark for single board computers
- [self-hosted](https://github.com/getsentry/self-hosted) (9583 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (268604 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2896 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [steam-runtime](https://github.com/ValveSoftware/steam-runtime) (1455 stars) - A runtime environment for Steam applications
...
- [superpowers](https://github.com/obra/superpowers) (290803 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3882 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13128 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [try](https://github.com/binpash/try) (5497 stars) - Inspect, control, and manipulate a command's effects before modifying your live system.
...
- [UserLAnd](https://github.com/CypherpunkArmory/UserLAnd) (4282 stars) - Main UserLAnd Repository
...
- [vscodium](https://github.com/VSCodium/vscodium) (33354 stars) - binary releases of VS Code without MS branding/telemetry/licensing
