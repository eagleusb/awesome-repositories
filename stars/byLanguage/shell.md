...
- [A2A](https://github.com/a2aproject/A2A) (25403 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3108 stars) - The Best GUI for Milvus
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21281 stars) - Collections of awesome neovim plugins.
...
- [claude-memory-skill](https://github.com/hanfang/claude-memory-skill) (49 stars) - A minimal, low-friction memory system for Claude Code
...
- [DietPi](https://github.com/MichaIng/DietPi) (6197 stars) - Lightweight justice for your single-board computer!
...
- [docker-bench-security](https://github.com/docker/docker-bench-security) (9691 stars) - The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
...
- [git-extras](https://github.com/tj/git-extras) (18093 stars) - GIT utilities -- repo summary, repl, changelog population, author commit percentages and more
...
- [gitflow](https://github.com/nvie/gitflow) (26798 stars) - Git extensions to provide high-level repository operations for Vincent Driessen's branching model.
...
- [imapsync](https://github.com/imapsync/imapsync) (4124 stars) - Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is 
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4254 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4054 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19561 stars) - An innovative superfamily of fonts for code
...
- [orbstack](https://github.com/orbstack/orbstack) (9207 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1269 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12569 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108825 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8021 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (60451 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5552 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9503 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (221570 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2670 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [super-linter](https://github.com/super-linter/super-linter) (10549 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (273707 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3831 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13079 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [vscodium](https://github.com/VSCodium/vscodium) (32874 stars) - binary releases of VS Code without MS branding/telemetry/licensing
