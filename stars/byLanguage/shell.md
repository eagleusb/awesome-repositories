...
- [A2A](https://github.com/a2aproject/A2A) (25448 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3114 stars) - The Best GUI for Milvus
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21299 stars) - Collections of awesome neovim plugins.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6202 stars) - Lightweight justice for your single-board computer!
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10294 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS.
...
- [imapsync](https://github.com/imapsync/imapsync) (4126 stars) - Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is 
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4287 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4094 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7922 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19571 stars) - An innovative superfamily of fonts for code
...
- [orbstack](https://github.com/orbstack/orbstack) (9218 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1275 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12573 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108905 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8030 stars) - Pixel perfect icon theme for Linux
- [pds](https://github.com/bluesky-social/pds) (2608 stars) - Bluesky PDS (Personal Data Server) container image, compose file, and documentation
- [pi-hole](https://github.com/pi-hole/pi-hole) (60529 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5558 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9509 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (229606 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2689 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [steam-runtime](https://github.com/ValveSoftware/steam-runtime) (1443 stars) - A runtime environment for Steam applications
- [super-linter](https://github.com/super-linter/super-linter) (10554 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (275673 stars) - An agentic skills framework & software development methodology that works.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13083 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [UserLAnd](https://github.com/CypherpunkArmory/UserLAnd) (4261 stars) - Main UserLAnd Repository
...
- [vscodium](https://github.com/VSCodium/vscodium) (32925 stars) - binary releases of VS Code without MS branding/telemetry/licensing
