...
- [A2A](https://github.com/a2aproject/A2A) (25927 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) (5948 stars) - An awesome & curated list of best LLMOps tools for developers
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21415 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15247 stars) - A community Bash framework.
...
- [claude-desktop-debian](https://github.com/aaddrick/claude-desktop-debian) (5408 stars) - Claude Desktop for Linux
...
- [DietPi](https://github.com/MichaIng/DietPi) (6300 stars) - Lightweight justice for your single-board computer!
...
- [extra-container](https://github.com/erikarvstedt/extra-container) (304 stars) - Run declarative NixOS containers without full system rebuilds
...
- [git-secret](https://github.com/sobolevn/git-secret) (4047 stars) - :busts_in_silhouette: A bash-tool to store your private data inside a git repository.
- [git-secrets](https://github.com/awslabs/git-secrets) (13405 stars) - Prevents you from committing secrets and credentials into git repositories
...
- [Hack](https://github.com/source-foundry/Hack) (17356 stars) - A typeface designed for source code
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4500 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [longhorn](https://github.com/longhorn/longhorn) (8004 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [orbstack](https://github.com/orbstack/orbstack) (9359 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1292 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12669 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (109977 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (8105 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (61065 stars) - A black hole for Internet advertisements
...
- [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) (3778 stars) - pre-commit git hooks to take care of Terraform configurations 🇺🇦
...
- [skills](https://github.com/mattpocock/skills) (269205 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2905 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [super-linter](https://github.com/super-linter/super-linter) (10605 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (291297 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3884 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13131 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [UserLAnd](https://github.com/CypherpunkArmory/UserLAnd) (4285 stars) - Main UserLAnd Repository
...
- [vscodium](https://github.com/VSCodium/vscodium) (33377 stars) - binary releases of VS Code without MS branding/telemetry/licensing
