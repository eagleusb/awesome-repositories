...
- [A2A](https://github.com/a2aproject/A2A) (25279 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [attu](https://github.com/zilliztech/attu) (3087 stars) - The Best GUI for Milvus
- [aviary.sh](https://github.com/frameable/aviary.sh) (1308 stars) - Minimal distributed configuration management in bash
- [Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) (5914 stars) - An awesome & curated list of best LLMOps tools for developers
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21242 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15137 stars) - A community Bash framework.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6187 stars) - Lightweight justice for your single-board computer!
...
- [docker-bench-security](https://github.com/docker/docker-bench-security) (9684 stars) - The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
...
- [dokku](https://github.com/dokku/dokku) (32106 stars) - A docker-powered PaaS that helps you build and manage the lifecycle of applications
...
- [ghostty-ubuntu](https://github.com/mkasberg/ghostty-ubuntu) (1220 stars) - Ubuntu/Debian (.deb) packages for Ghostty
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10282 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS.
...
- [imapsync](https://github.com/imapsync/imapsync) (4120 stars) - Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is 
- [jboss-autopwn](https://github.com/SpiderLabs/jboss-autopwn) (177 stars) - A JBoss script for obtaining remote shell access
- [JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) (12943 stars) - JetBrains Mono – the free and open-source typeface for developers
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4202 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (4007 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7909 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [nginx-admins-handbook](https://github.com/trimstray/nginx-admins-handbook) (14299 stars) - How to improve NGINX performance, security, and other important things.
- [nono-packs](https://github.com/always-further/nono-packs) (23 stars) - Repository for always further maintained nono packages
- [notes](https://github.com/8483/notes) (3392 stars) - Full-stack web development notes
...
- [orbstack](https://github.com/orbstack/orbstack) (9167 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1264 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12539 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108644 stars) - Papers from the computer science community to read and discuss.
- [papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) (7996 stars) - Pixel perfect icon theme for Linux
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (60297 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5511 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 500+ PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9493 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (212700 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2602 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [super-linter](https://github.com/super-linter/super-linter) (10540 stars) - Combination of multiple linters to run as a GitHub Action or standalone
- [superpowers](https://github.com/obra/superpowers) (270283 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3821 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
...
- [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) (13072 stars) - 💥 A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
- [try](https://github.com/binpash/try) (5484 stars) - Inspect, control, and manipulate a command's effects before modifying your live system.
...
- [vscodium](https://github.com/VSCodium/vscodium) (32761 stars) - binary releases of VS Code without MS branding/telemetry/licensing
