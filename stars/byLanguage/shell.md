...
- [A2A](https://github.com/a2aproject/A2A) (25265 stars) - Agent2Agent (A2A) is an open protocol enabling communication and interoperability between opaque agentic applications.
...
- [awesome-neovim](https://github.com/rockerBOO/awesome-neovim) (21238 stars) - Collections of awesome neovim plugins.
...
- [bash-it](https://github.com/Bash-it/bash-it) (15136 stars) - A community Bash framework.
...
- [bluefin](https://github.com/ublue-os/bluefin) (2560 stars) - The next generation Linux workstation, designed for reliability, performance, and sustainability.
...
- [DietPi](https://github.com/MichaIng/DietPi) (6185 stars) - Lightweight justice for your single-board computer!
...
- [docker-github-actions-runner](https://github.com/myoung34/docker-github-actions-runner) (2407 stars) - This will run the new self-hosted github actions runners with docker-in-docker
...
- [dokku](https://github.com/dokku/dokku) (32105 stars) - A docker-powered PaaS that helps you build and manage the lifecycle of applications
...
- [ghostty-ubuntu](https://github.com/mkasberg/ghostty-ubuntu) (1219 stars) - Ubuntu/Debian (.deb) packages for Ghostty
...
- [git-secrets](https://github.com/awslabs/git-secrets) (13367 stars) - Prevents you from committing secrets and credentials into git repositories
...
- [Gogh](https://github.com/Gogh-Co/Gogh) (10281 stars) - Gogh is a collection of color schemes for various terminal emulators, including Gnome Terminal, Pantheon Terminal, Tilix, and XFCE4 Terminal also compatible with iTerm on macOS.
...
- [imapsync](https://github.com/imapsync/imapsync) (4119 stars) - Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is 
- [jboss-autopwn](https://github.com/SpiderLabs/jboss-autopwn) (177 stars) - A JBoss script for obtaining remote shell access
- [JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) (12944 stars) - JetBrains Mono – the free and open-source typeface for developers
...
- [linux-cachyos](https://github.com/CachyOS/linux-cachyos) (4197 stars) - Archlinux Kernel based on different schedulers and some other performance improvements.
...
- [llm-d](https://github.com/llm-d/llm-d) (3999 stars) - Achieve state of the art inference performance with modern accelerators on Kubernetes
- [longhorn](https://github.com/longhorn/longhorn) (7906 stars) - Cloud-Native distributed storage built on and for Kubernetes
...
- [monaspace](https://github.com/githubnext/monaspace) (19544 stars) - An innovative superfamily of fonts for code
...
- [orbstack](https://github.com/orbstack/orbstack) (9157 stars) - Fast, light, simple Docker containers & Linux machines
- [os](https://github.com/wolfi-dev/os) (1263 stars) - Main package repository for production Wolfi images
- [oss-fuzz](https://github.com/google/oss-fuzz) (12532 stars) - OSS-Fuzz - continuous fuzzing for open source software.
- [pagerduty-monit](https://github.com/pinterest/pagerduty-monit) (60 stars) - Wrapper scripts to integrate monit and PagerDuty.
- [papers-we-love](https://github.com/papers-we-love/papers-we-love) (108614 stars) - Papers from the computer science community to read and discuss.
...
- [pi-hole](https://github.com/pi-hole/pi-hole) (60275 stars) - A black hole for Internet advertisements
- [pigsty](https://github.com/pgsty/pigsty) (5508 stars) - Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 500+ PG extensions. Best-of-breed products integrated as a platform. Self-host Postgres like a Pro!
...
- [self-hosted](https://github.com/getsentry/self-hosted) (9489 stars) - Sentry, feature-complete and packaged up for low-volume deployments and proofs-of-concept
...
- [skills](https://github.com/mattpocock/skills) (211345 stars) - Skills for Real Engineers. Straight from my .agents directory.
- [skills](https://github.com/cloudflare/skills) (2592 stars) - Skills for teaching agents how to build on Cloudflare.
...
- [superpowers](https://github.com/obra/superpowers) (269777 stars) - An agentic skills framework & software development methodology that works.
...
- [sysbox](https://github.com/nestybox/sysbox) (3819 stars) - An open-source, next-generation "runc" that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs.
- [TALA](https://github.com/terrastruct/TALA) (296 stars) - A diagram layout engine designed specifically for software architecture diagrams
...
- [uusec-waf](https://github.com/Safe3/uusec-waf) (1698 stars) - Industry-leading free, high-performance, AI and semantic technology Web Application Firewall and API Security Gateway (WAAP) - UUSEC WAF.
...
- [vscodium](https://github.com/VSCodium/vscodium) (32742 stars) - binary releases of VS Code without MS branding/telemetry/licensing
