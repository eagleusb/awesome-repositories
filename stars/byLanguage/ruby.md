...
- [canine](https://github.com/CanineHQ/canine) (2809 stars) - A developer friendly PaaS for your Kubernetes
- [chatwoot](https://github.com/chatwoot/chatwoot) (28230 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
...
- [dawarich](https://github.com/Freika/dawarich) (8588 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
- [decidim](https://github.com/decidim/decidim) (1729 stars) - The participatory democracy framework. A generator and multiple gems made with Ruby on Rails
- [discourse](https://github.com/discourse/discourse) (46691 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37699 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41309 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
...
- [huginn](https://github.com/huginn/huginn) (49046 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [mastodon](https://github.com/mastodon/mastodon) (49800 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37835 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14760 stars) - OpenProject is the leading open source project management software.
...
- [spree](https://github.com/spree/spree) (15316 stars) - Open-source commerce platform for fast growing businesses and enterprises. Supports complex commerce scenarios natively - from B2B wholesale to multi-vendor marketplace to global multi-region or multi-tenant ecommerce.
...
- [sure](https://github.com/we-promise/sure) (7648 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [upright](https://github.com/basecamp/upright) (767 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
- [vane](https://github.com/delvelabs/vane) (214 stars) - A GPL fork of the popular wordpress vulnerability scanner WPScan
- [wpscan](https://github.com/wpscanteam/wpscan) (9529 stars) - WPScan WordPress security scanner. Written for security professionals and blog maintainers to test the security of their WordPress websites. Contact us via contact@wpscan.com
