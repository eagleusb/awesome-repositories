...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14261 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [chatwoot](https://github.com/chatwoot/chatwoot) (30440 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
...
- [dawarich](https://github.com/Freika/dawarich) (9293 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (47244 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (38283 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41640 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13551 stars) - Fluentd: Unified Logging Layer (project under CNCF)
- [foreman](https://github.com/theforeman/foreman) (2878 stars) - an application that automates the lifecycle of servers 
...
- [huginn](https://github.com/huginn/huginn) (49456 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (38368 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (15282 stars) - OpenProject is the leading open source project management software.
...
- [spree](https://github.com/spree/spree) (15472 stars) - Open-source headless eCommerce platform with REST API, TypeScript SDK, and Next.js storefront for cross-border, B2B or marketplace eCommerce.
...
- [sure](https://github.com/we-promise/sure) (8638 stars) - The personal finance app for everyone (by everyone)
...
- [wpscan](https://github.com/wpscanteam/wpscan) (9626 stars) - WPScan WordPress security scanner. Written for security professionals and blog maintainers to test the security of their WordPress websites. Contact us via contact@wpscan.com
