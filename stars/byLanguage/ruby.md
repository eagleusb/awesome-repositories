...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14054 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [chatwoot](https://github.com/chatwoot/chatwoot) (27992 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
- [chef](https://github.com/chef/chef) (8368 stars) - Chef Infra, a powerful automation platform that transforms infrastructure into code automating how infrastructure is configured, deployed and managed across any environment, at any scale
...
- [dawarich](https://github.com/Freika/dawarich) (8375 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (46618 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37578 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41224 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13513 stars) - Fluentd: Unified Logging Layer (project under CNCF)
...
- [gollum](https://github.com/gollum/gollum) (14240 stars) - A simple, Git-powered wiki with a local frontend and support for many kinds of markup and content.
...
- [huginn](https://github.com/huginn/huginn) (48933 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [mastodon](https://github.com/mastodon/mastodon) (49774 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37767 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14653 stars) - OpenProject is the leading open source project management software.
- [oxidized](https://github.com/ytti/oxidized) (3318 stars) - Oxidized is a network device configuration backup tool. It's a RANCID replacement!
- [partiql-spec](https://github.com/partiql/partiql-spec) (149 stars) - The language specification of PartiQL.
- [pghero](https://github.com/ankane/pghero) (8819 stars) - A performance dashboard for Postgres
- [postal](https://github.com/postalserver/postal) (16408 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [spree](https://github.com/spree/spree) (15285 stars) - Spree is an API-first, open-source eCommerce platform for fast growing businesses and enterprises. Spree supports complex commerce scenarios natively — from B2B wholesale to multi-vendor marketplace to global multi-region or multi-tenant distributor platforms. Use each model independently or combine them as your business evolves.
...
- [sure](https://github.com/we-promise/sure) (7466 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [terraspace](https://github.com/boltops-tools/terraspace) (712 stars) - Terraspace: The Terraform Framework
- [thredded](https://github.com/thredded/thredded) (1603 stars) - The best Rails forums engine ever.
- [upright](https://github.com/basecamp/upright) (723 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
- [vane](https://github.com/delvelabs/vane) (214 stars) - A GPL fork of the popular wordpress vulnerability scanner WPScan
- [wpscan](https://github.com/wpscanteam/wpscan) (9516 stars) - WPScan WordPress security scanner. Written for security professionals and blog maintainers to test the security of their WordPress websites. Contact us via contact@wpscan.com
