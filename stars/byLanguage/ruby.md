...
- [api-umbrella](https://github.com/NatLabRockies/api-umbrella) (2171 stars) - Open source API management platform
- [aptly_cli](https://github.com/sepulworld/aptly_cli) (44 stars) - Aptly client
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14258 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [chatwoot](https://github.com/chatwoot/chatwoot) (30066 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
- [chef](https://github.com/chef/chef) (8189 stars) - Chef Infra, a powerful automation platform that transforms infrastructure into code automating how infrastructure is configured, deployed and managed across any environment, at any scale
...
- [dawarich](https://github.com/Freika/dawarich) (9271 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
- [decidim](https://github.com/decidim/decidim) (1765 stars) - The participatory democracy framework. A generator and multiple gems made with Ruby on Rails
- [discourse](https://github.com/discourse/discourse) (47223 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (38272 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41632 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
...
- [fpm](https://github.com/jordansissel/fpm) (11477 stars) - Effing package management! Build packages for multiple platforms (deb, rpm, etc) with great ease and sanity.
...
- [huginn](https://github.com/huginn/huginn) (49448 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [mastodon](https://github.com/mastodon/mastodon) (50014 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (38355 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (15257 stars) - OpenProject is the leading open source project management software.
...
- [postal](https://github.com/postalserver/postal) (16595 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [puppet](https://github.com/puppetlabs/puppet) (7877 stars) - Server automation framework and application
...
- [spree](https://github.com/spree/spree) (15465 stars) - Open-source headless eCommerce platform with REST API, TypeScript SDK, and Next.js storefront for cross-border, B2B or marketplace eCommerce.
...
- [sure](https://github.com/we-promise/sure) (8613 stars) - The personal finance app for everyone (by everyone)
