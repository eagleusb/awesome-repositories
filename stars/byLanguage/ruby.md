...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14076 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [chatwoot](https://github.com/chatwoot/chatwoot) (28112 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
...
- [dawarich](https://github.com/Freika/dawarich) (8521 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (46658 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37669 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41284 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13514 stars) - Fluentd: Unified Logging Layer (project under CNCF)
- [foreman](https://github.com/theforeman/foreman) (2842 stars) - an application that automates the lifecycle of servers 
...
- [huginn](https://github.com/huginn/huginn) (49007 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
- [inspec](https://github.com/inspec/inspec) (3056 stars) - InSpec: Auditing and Testing Framework
...
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37802 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14732 stars) - OpenProject is the leading open source project management software.
...
- [postal](https://github.com/postalserver/postal) (16427 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [solidus](https://github.com/solidusio/solidus) (5279 stars) - 🛒 Solidus, the open-source eCommerce framework for industry trailblazers.
- [spree](https://github.com/spree/spree) (15301 stars) - Open-source commerce platform for fast growing businesses and enterprises. Supports complex commerce scenarios natively - from B2B wholesale to multi-vendor marketplace to global multi-region or multi-tenant ecommerce.
...
- [sure](https://github.com/we-promise/sure) (7582 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [wpscan](https://github.com/wpscanteam/wpscan) (9524 stars) - WPScan WordPress security scanner. Written for security professionals and blog maintainers to test the security of their WordPress websites. Contact us via contact@wpscan.com
