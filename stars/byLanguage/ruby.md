...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14052 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [chatwoot](https://github.com/chatwoot/chatwoot) (27966 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
...
- [dawarich](https://github.com/Freika/dawarich) (8371 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (46612 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37571 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41218 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
...
- [huginn](https://github.com/huginn/huginn) (48923 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
- [inspec](https://github.com/inspec/inspec) (3054 stars) - InSpec: Auditing and Testing Framework
...
- [mastodon](https://github.com/mastodon/mastodon) (49773 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37762 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14643 stars) - OpenProject is the leading open source project management software.
...
- [postal](https://github.com/postalserver/postal) (16407 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [solidus](https://github.com/solidusio/solidus) (5274 stars) - 🛒 Solidus, the open-source eCommerce framework for industry trailblazers.
...
- [sure](https://github.com/we-promise/sure) (7459 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [upright](https://github.com/basecamp/upright) (722 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
