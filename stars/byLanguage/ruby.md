...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14061 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [canine](https://github.com/CanineHQ/canine) (2799 stars) - A developer friendly PaaS for your Kubernetes
- [chatwoot](https://github.com/chatwoot/chatwoot) (28063 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
...
- [dawarich](https://github.com/Freika/dawarich) (8403 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (46644 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37636 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41268 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13516 stars) - Fluentd: Unified Logging Layer (project under CNCF)
- [foreman](https://github.com/theforeman/foreman) (2833 stars) - an application that automates the lifecycle of servers 
...
- [gollum](https://github.com/gollum/gollum) (14244 stars) - A simple, Git-powered wiki with a local frontend and support for many kinds of markup and content.
...
- [huginn](https://github.com/huginn/huginn) (48976 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [mastodon](https://github.com/mastodon/mastodon) (49788 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37786 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14696 stars) - OpenProject is the leading open source project management software.
...
- [postal](https://github.com/postalserver/postal) (16420 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [solidus](https://github.com/solidusio/solidus) (5277 stars) - 🛒 Solidus, the open-source eCommerce framework for industry trailblazers.
- [spree](https://github.com/spree/spree) (15294 stars) - Open-source commerce platform for fast growing businesses and enterprises. Supports complex commerce scenarios natively - from B2B wholesale to multi-vendor marketplace to global multi-region or multi-tenant ecommerce.
...
- [sure](https://github.com/we-promise/sure) (7521 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [upright](https://github.com/basecamp/upright) (735 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
- [vane](https://github.com/delvelabs/vane) (214 stars) - A GPL fork of the popular wordpress vulnerability scanner WPScan
- [wpscan](https://github.com/wpscanteam/wpscan) (9523 stars) - WPScan WordPress security scanner. Written for security professionals and blog maintainers to test the security of their WordPress websites. Contact us via contact@wpscan.com
