...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14075 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [backup](https://github.com/backup/backup) (4876 stars) - Easy full stack backup operations on UNIX-like systems.
...
- [canine](https://github.com/CanineHQ/canine) (2807 stars) - A developer friendly PaaS for your Kubernetes
- [chatwoot](https://github.com/chatwoot/chatwoot) (28099 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
- [chef](https://github.com/chef/chef) (8371 stars) - Chef Infra, a powerful automation platform that transforms infrastructure into code automating how infrastructure is configured, deployed and managed across any environment, at any scale
...
- [dawarich](https://github.com/Freika/dawarich) (8434 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (46650 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37659 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41278 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13516 stars) - Fluentd: Unified Logging Layer (project under CNCF)
- [foreman](https://github.com/theforeman/foreman) (2840 stars) - an application that automates the lifecycle of servers 
...
- [huginn](https://github.com/huginn/huginn) (48996 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [mastodon](https://github.com/mastodon/mastodon) (49785 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37796 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14719 stars) - OpenProject is the leading open source project management software.
...
- [spree](https://github.com/spree/spree) (15302 stars) - Open-source commerce platform for fast growing businesses and enterprises. Supports complex commerce scenarios natively - from B2B wholesale to multi-vendor marketplace to global multi-region or multi-tenant ecommerce.
...
- [sure](https://github.com/we-promise/sure) (7575 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [upright](https://github.com/basecamp/upright) (757 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
