...
- [api-umbrella](https://github.com/NatLabRockies/api-umbrella) (2172 stars) - Open source API management platform
- [aptly_cli](https://github.com/sepulworld/aptly_cli) (44 stars) - Aptly client
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14259 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [canine](https://github.com/CanineHQ/canine) (2866 stars) - A developer friendly PaaS for your Kubernetes
- [chatwoot](https://github.com/chatwoot/chatwoot) (30094 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
...
- [dawarich](https://github.com/Freika/dawarich) (9286 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (47231 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (38277 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41635 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13551 stars) - Fluentd: Unified Logging Layer (project under CNCF)
- [foreman](https://github.com/theforeman/foreman) (2875 stars) - an application that automates the lifecycle of servers 
...
- [huginn](https://github.com/huginn/huginn) (49454 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (38361 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (15266 stars) - OpenProject is the leading open source project management software.
...
- [postal](https://github.com/postalserver/postal) (16594 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [solidus](https://github.com/solidusio/solidus) (5304 stars) - 🛒 Solidus, the open-source eCommerce framework for industry trailblazers.
- [spree](https://github.com/spree/spree) (15470 stars) - Open-source headless eCommerce platform with REST API, TypeScript SDK, and Next.js storefront for cross-border, B2B or marketplace eCommerce.
...
- [sure](https://github.com/we-promise/sure) (8626 stars) - The personal finance app for everyone (by everyone)
