...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14081 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [chatwoot](https://github.com/chatwoot/chatwoot) (28173 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
...
- [dawarich](https://github.com/Freika/dawarich) (8565 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (46680 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37689 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41304 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13514 stars) - Fluentd: Unified Logging Layer (project under CNCF)
- [foreman](https://github.com/theforeman/foreman) (2844 stars) - an application that automates the lifecycle of servers 
...
- [huginn](https://github.com/huginn/huginn) (49027 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37823 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14750 stars) - OpenProject is the leading open source project management software.
...
- [postal](https://github.com/postalserver/postal) (16429 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [spree](https://github.com/spree/spree) (15310 stars) - Open-source commerce platform for fast growing businesses and enterprises. Supports complex commerce scenarios natively - from B2B wholesale to multi-vendor marketplace to global multi-region or multi-tenant ecommerce.
...
- [sure](https://github.com/we-promise/sure) (7613 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [upright](https://github.com/basecamp/upright) (765 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
