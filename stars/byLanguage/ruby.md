...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14068 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [canine](https://github.com/CanineHQ/canine) (2804 stars) - A developer friendly PaaS for your Kubernetes
- [chatwoot](https://github.com/chatwoot/chatwoot) (28081 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
- [chef](https://github.com/chef/chef) (8370 stars) - Chef Infra, a powerful automation platform that transforms infrastructure into code automating how infrastructure is configured, deployed and managed across any environment, at any scale
- [ciao](https://github.com/brotandgames/ciao) (1956 stars) - HTTP checks & tests (private & public) monitoring - check the status of your URL
...
- [dawarich](https://github.com/Freika/dawarich) (8412 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
- [decidim](https://github.com/decidim/decidim) (1728 stars) - The participatory democracy framework. A generator and multiple gems made with Ruby on Rails
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (37644 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41277 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
- [fluentd](https://github.com/fluent/fluentd) (13517 stars) - Fluentd: Unified Logging Layer (project under CNCF)
- [foreman](https://github.com/theforeman/foreman) (2835 stars) - an application that automates the lifecycle of servers 
...
- [huginn](https://github.com/huginn/huginn) (48982 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [mastodon](https://github.com/mastodon/mastodon) (49786 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (37789 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (14710 stars) - OpenProject is the leading open source project management software.
- [oxidized](https://github.com/ytti/oxidized) (3324 stars) - Oxidized is a network device configuration backup tool. It's a RANCID replacement!
- [partiql-spec](https://github.com/partiql/partiql-spec) (149 stars) - The language specification of PartiQL.
- [pghero](https://github.com/ankane/pghero) (8825 stars) - A performance dashboard for Postgres
- [postal](https://github.com/postalserver/postal) (16421 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [scientist](https://github.com/github/scientist) (7702 stars) - :microscope: A Ruby library for carefully refactoring critical paths.
...
- [spree](https://github.com/spree/spree) (15295 stars) - Open-source commerce platform for fast growing businesses and enterprises. Supports complex commerce scenarios natively - from B2B wholesale to multi-vendor marketplace to global multi-region or multi-tenant ecommerce.
...
- [sure](https://github.com/we-promise/sure) (7535 stars) - The personal finance app for everyone. NOT affiliated with or endorsed by Maybe Finance Inc.
...
- [upright](https://github.com/basecamp/upright) (750 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
- [vane](https://github.com/delvelabs/vane) (214 stars) - A GPL fork of the popular wordpress vulnerability scanner WPScan
- [wpscan](https://github.com/wpscanteam/wpscan) (9526 stars) - WPScan WordPress security scanner. Written for security professionals and blog maintainers to test the security of their WordPress websites. Contact us via contact@wpscan.com
