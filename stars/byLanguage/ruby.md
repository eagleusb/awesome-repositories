...
- [awesome-stock-resources](https://github.com/neutraltone/awesome-stock-resources) (14266 stars) - :city_sunrise: A collection of links for free stock photography, video and Illustration websites
...
- [chatwoot](https://github.com/chatwoot/chatwoot) (31345 stars) - Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
- [chef](https://github.com/chef/chef) (8190 stars) - Chef Infra, a powerful automation platform that transforms infrastructure into code automating how infrastructure is configured, deployed and managed across any environment, at any scale
...
- [dawarich](https://github.com/Freika/dawarich) (9332 stars) - Your favorite self-hostable alternative to Google Timeline (Google Location History)
...
- [discourse](https://github.com/discourse/discourse) (47260 stars) - A platform for community discussion. Free, open, simple.
...
- [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) (38297 stars) - A curated list of engineering blogs
...
- [fastlane](https://github.com/fastlane/fastlane) (41653 stars) - 🚀 The easiest way to automate building and releasing your iOS and Android apps
...
- [huginn](https://github.com/huginn/huginn) (49474 stars) - Create agents that monitor and act on your behalf.  Your agents are standing by!
...
- [mastodon](https://github.com/mastodon/mastodon) (50032 stars) - Your self-hosted, globally interconnected microblogging community
- [metasploit-framework](https://github.com/rapid7/metasploit-framework) (38390 stars) - Metasploit Framework
...
- [openproject](https://github.com/opf/openproject) (15307 stars) - OpenProject is the leading open source project management software.
...
- [postal](https://github.com/postalserver/postal) (16602 stars) - 📮 A fully featured open source mail delivery platform for incoming & outgoing e-mail
...
- [puppet](https://github.com/puppetlabs/puppet) (7881 stars) - Server automation framework and application
...
- [sure](https://github.com/we-promise/sure) (8682 stars) - The personal finance app for everyone (by everyone)
...
- [upright](https://github.com/basecamp/upright) (806 stars) - Synthetic monitoring engine with Playwright and Prometheus metrics
- [vane](https://github.com/delvelabs/vane) (213 stars) - A GPL fork of the popular wordpress vulnerability scanner WPScan
- [wpscan](https://github.com/wpscanteam/wpscan) (9628 stars) - WPScan WordPress security scanner. Written for security professionals and blog maintainers to test the security of their WordPress websites. Contact us via contact@wpscan.com
