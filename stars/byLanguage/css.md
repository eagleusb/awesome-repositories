## CSS (30 repositories) 
- [98.css](https://github.com/jdan/98.css) (10987 stars) - A design system for building faithful recreations of old UIs
- [animate.css](https://github.com/animate-css/animate.css) (82540 stars) - 🍿 A cross-browser library of CSS animations. As easy to use as an easy thing.
- [arc-theme](https://github.com/horst3180/arc-theme) (8261 stars) - A flat theme with transparent elements
- [awesome-css-frameworks](https://github.com/troxler/awesome-css-frameworks) (9284 stars) - List of awesome CSS frameworks in 2026
...
- [cs16.css](https://github.com/ekmas/cs16.css) (1982 stars) - CSS library based on Counter Strike 1.6 UI.
...
- [goflow](https://github.com/s8sg/goflow) (1370 stars) - A Golang based high performance, scalable and distributed workflow framework
...
- [hugo-theme-terminal](https://github.com/panr/hugo-theme-terminal) (2708 stars) - A simple, retro theme for Hugo
...
- [mazanoke](https://github.com/civilblur/mazanoke) (2557 stars) - A self-hosted local image optimizer that runs in your browser.
- [Nordic](https://github.com/EliverLara/Nordic) (2673 stars) - :snowflake: Dark Gtk3.20+ theme created using the awesome Nord color pallete.
...
- [Practical-Cryptography-for-Developers-Book](https://github.com/nakov/Practical-Cryptography-for-Developers-Book) (3789 stars) - Practical Cryptography for Developers: Hashes, MAC, Key Derivation, DHKE, Symmetric and Asymmetric Ciphers, Public Key Cryptosystems, RSA, Elliptic Curves, ECC, secp256k1, ECDH, ECIES, Digital Signatures, ECDSA, EdDSA
...
- [source-code-pro](https://github.com/adobe-fonts/source-code-pro) (20384 stars) - Monospaced font family for user interface and coding environments
