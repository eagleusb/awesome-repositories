## CSS (29 repositories) 
- [98.css](https://github.com/jdan/98.css) (11052 stars) - A design system for building faithful recreations of old UIs
- [animate.css](https://github.com/animate-css/animate.css) (82522 stars) - 🍿 A cross-browser library of CSS animations. As easy to use as an easy thing.
- [arc-theme](https://github.com/horst3180/arc-theme) (8258 stars) - A flat theme with transparent elements
- [awesome-css-frameworks](https://github.com/troxler/awesome-css-frameworks) (9331 stars) - List of awesome CSS frameworks in 2026
...
- [dalai](https://github.com/cocktailpeanut/dalai) (12939 stars) - The simplest way to run LLaMA on your local machine
...
- [hugo-theme-terminal](https://github.com/panr/hugo-theme-terminal) (2751 stars) - A simple, retro theme for Hugo
...
- [Practical-Cryptography-for-Developers-Book](https://github.com/nakov/Practical-Cryptography-for-Developers-Book) (3799 stars) - Practical Cryptography for Developers: Hashes, MAC, Key Derivation, DHKE, Symmetric and Asymmetric Ciphers, Public Key Cryptosystems, RSA, Elliptic Curves, ECC, secp256k1, ECDH, ECIES, Digital Signatures, ECDSA, EdDSA
...
- [source-code-pro](https://github.com/adobe-fonts/source-code-pro) (20401 stars) - Monospaced font family for user interface and coding environments
