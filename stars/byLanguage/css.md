## CSS (29 repositories) 
- [98.css](https://github.com/jdan/98.css) (11078 stars) - A design system for building faithful recreations of old UIs
- [animate.css](https://github.com/animate-css/animate.css) (82554 stars) - 🍿 A cross-browser library of CSS animations. As easy to use as an easy thing.
- [arc-theme](https://github.com/horst3180/arc-theme) (8254 stars) - A flat theme with transparent elements
- [awesome-css-frameworks](https://github.com/troxler/awesome-css-frameworks) (9348 stars) - List of awesome CSS frameworks in 2026
...
- [cs16.css](https://github.com/ekmas/cs16.css) (1995 stars) - CSS library based on Counter Strike 1.6 UI.
- [csstyle](https://github.com/csstyle-org/csstyle) (49 stars) - clean, simple styling for styling the web.
- [dalai](https://github.com/cocktailpeanut/dalai) (12931 stars) - The simplest way to run LLaMA on your local machine
- [Fira](https://github.com/mozilla/Fira) (5161 stars) - DEPRECATED - Mozilla's new typeface, used in Firefox OS
- [goflow](https://github.com/s8sg/goflow) (1376 stars) - A Golang based high performance, scalable and distributed workflow framework
...
- [hugo-theme-terminal](https://github.com/panr/hugo-theme-terminal) (2756 stars) - A simple, retro theme for Hugo
- [juliamono](https://github.com/cormullion/juliamono) (1649 stars) - JuliaMono is a monospaced font for scientific and technical users, with comprehensive Unicode support.
...
- [source-code-pro](https://github.com/adobe-fonts/source-code-pro) (20412 stars) - Monospaced font family for user interface and coding environments
...
- [tachyons](https://github.com/tachyons-css/tachyons) (11704 stars) - Functional css for humans
