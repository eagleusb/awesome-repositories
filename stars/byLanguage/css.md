## CSS (30 repositories) 
- [98.css](https://github.com/jdan/98.css) (11042 stars) - A design system for building faithful recreations of old UIs
...
- [awesome-css-frameworks](https://github.com/troxler/awesome-css-frameworks) (9323 stars) - List of awesome CSS frameworks in 2026
...
- [cs16.css](https://github.com/ekmas/cs16.css) (1989 stars) - CSS library based on Counter Strike 1.6 UI.
- [csstyle](https://github.com/csstyle-org/csstyle) (49 stars) - clean, simple styling for styling the web.
- [dalai](https://github.com/cocktailpeanut/dalai) (12945 stars) - The simplest way to run LLaMA on your local machine
...
- [hugo-theme-terminal](https://github.com/panr/hugo-theme-terminal) (2743 stars) - A simple, retro theme for Hugo
- [juliamono](https://github.com/cormullion/juliamono) (1640 stars) - JuliaMono is a monospaced font for scientific and technical users, with comprehensive Unicode support.
...
- [mazanoke](https://github.com/civilblur/mazanoke) (2582 stars) - A self-hosted local image optimizer that runs in your browser.
- [Nordic](https://github.com/EliverLara/Nordic) (2683 stars) - :snowflake: Dark Gtk3.20+ theme created using the awesome Nord color pallete.
...
- [Practical-Cryptography-for-Developers-Book](https://github.com/nakov/Practical-Cryptography-for-Developers-Book) (3798 stars) - Practical Cryptography for Developers: Hashes, MAC, Key Derivation, DHKE, Symmetric and Asymmetric Ciphers, Public Key Cryptosystems, RSA, Elliptic Curves, ECC, secp256k1, ECDH, ECIES, Digital Signatures, ECDSA, EdDSA
