## CSS (29 repositories) 
- [98.css](https://github.com/jdan/98.css) (11065 stars) - A design system for building faithful recreations of old UIs
- [animate.css](https://github.com/animate-css/animate.css) (82549 stars) - 🍿 A cross-browser library of CSS animations. As easy to use as an easy thing.
- [arc-theme](https://github.com/horst3180/arc-theme) (8256 stars) - A flat theme with transparent elements
- [awesome-css-frameworks](https://github.com/troxler/awesome-css-frameworks) (9341 stars) - List of awesome CSS frameworks in 2026
...
- [dalai](https://github.com/cocktailpeanut/dalai) (12935 stars) - The simplest way to run LLaMA on your local machine
...
- [hugo-theme-terminal](https://github.com/panr/hugo-theme-terminal) (2754 stars) - A simple, retro theme for Hugo
...
- [Practical-Cryptography-for-Developers-Book](https://github.com/nakov/Practical-Cryptography-for-Developers-Book) (3801 stars) - Practical Cryptography for Developers: Hashes, MAC, Key Derivation, DHKE, Symmetric and Asymmetric Ciphers, Public Key Cryptosystems, RSA, Elliptic Curves, ECC, secp256k1, ECDH, ECIES, Digital Signatures, ECDSA, EdDSA
