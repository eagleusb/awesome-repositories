## CSS (32 repositories) 
- [98.css](https://github.com/jdan/98.css) (10968 stars) - A design system for building faithful recreations of old UIs
- [animate.css](https://github.com/animate-css/animate.css) (82625 stars) - 🍿 A cross-browser library of CSS animations. As easy to use as an easy thing.
- [arc-theme](https://github.com/horst3180/arc-theme) (8260 stars) - A flat theme with transparent elements
- [awesome-css-frameworks](https://github.com/troxler/awesome-css-frameworks) (9278 stars) - List of awesome CSS frameworks in 2026
...
- [awesome-prometheus-alerts](https://github.com/samber/awesome-prometheus-alerts) (7821 stars) - 🚨 Collection of Prometheus alerting rules
- [bearblog](https://github.com/HermanMartinus/bearblog) (4815 stars) - Free, no-nonsense, super fast blogging.
...
- [dalai](https://github.com/cocktailpeanut/dalai) (12971 stars) - The simplest way to run LLaMA on your local machine
...
- [hugo-theme-terminal](https://github.com/panr/hugo-theme-terminal) (2705 stars) - A simple, retro theme for Hugo
...
- [mazanoke](https://github.com/civilblur/mazanoke) (2512 stars) - A self-hosted local image optimizer that runs in your browser.
...
- [source-code-pro](https://github.com/adobe-fonts/source-code-pro) (20382 stars) - Monospaced font family for user interface and coding environments
