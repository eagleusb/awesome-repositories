## C (354 repositories) 
- [3proxy](https://github.com/3proxy/3proxy) (5004 stars) - 3proxy - tiny free proxy server
...
- [AppImageKit](https://github.com/AppImage/AppImageKit) (9289 stars) - Package desktop applications as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, openSUSE, SLED, Ubuntu, Fedora, debian and derivatives. Join #AppImage on irc.libera.chat
- [arkime](https://github.com/arkime/arkime) (7327 stars) - Arkime is an open source, large scale, full packet capturing, indexing, and database system.
...
- [barrier](https://github.com/debauchee/barrier) (30344 stars) - Open-source KVM software
- [bcc](https://github.com/iovisor/bcc) (22289 stars) - BCC - Tools for BPF-based Linux IO analysis, networking, monitoring, and more
...
- [endlessh](https://github.com/skeeto/endlessh) (8420 stars) - SSH tarpit that slowly sends an endless banner
- [entr](https://github.com/eradman/entr) (5499 stars) - Run arbitrary commands when files change
...
- [htop](https://github.com/htop-dev/htop) (7910 stars) - htop - an interactive process viewer
...
- [ics-openvpn](https://github.com/schwabe/ics-openvpn) (3832 stars) - OpenVPN for Android
...
- [iodine](https://github.com/yarrick/iodine) (7746 stars) - Official git repo for iodine dns tunnel
...
- [kilo](https://github.com/antirez/kilo) (8803 stars) - A text editor in less than 1000 LOC with syntax highlight and search.
- [kpatch](https://github.com/dynup/kpatch) (1673 stars) - kpatch - live kernel patching
- [krackattacks-scripts](https://github.com/vanhoefm/krackattacks-scripts) (3496 stars) - Unknown
- [kvm](https://github.com/jetkvm/kvm) (4458 stars) - JetKVM - Control any computer remotely
- [lede](https://github.com/coolsnowwolf/lede) (31388 stars) - Lean's LEDE source
- [legato-af](https://github.com/legatoproject/legato-af) (163 stars) - Legato Application Framework
- [libsodium](https://github.com/jedisct1/libsodium) (13533 stars) - A modern, portable, easy to use crypto library.
- [libsql](https://github.com/tursodatabase/libsql) (16526 stars) - libSQL is a fork of SQLite that is both Open Source, and Open Contributions.
- [libuv](https://github.com/libuv/libuv) (26689 stars) - Cross-platform asynchronous I/O
...
- [MeshCore](https://github.com/meshcore-dev/MeshCore) (2284 stars) - A new lightweight, hybrid routing mesh protocol for packet radios
- [mimikatz](https://github.com/gentilkiwi/mimikatz) (21347 stars) - A little tool to play with Windows security
...
- [minisign](https://github.com/jedisct1/minisign) (2690 stars) - A dead simple tool to sign files and verify digital signatures.
...
- [netdata](https://github.com/netdata/netdata) (78151 stars) - The fastest path to AI-powered full stack observability, even for lean teams.
...
- [pcileech](https://github.com/ufrisk/pcileech) (7504 stars) - Direct Memory Access (DMA) Attack Software
...
- [pg_repack](https://github.com/reorg/pg_repack) (2195 stars) - Reorganize tables in PostgreSQL databases with minimal locks
...
- [pgbackrest](https://github.com/pgbackrest/pgbackrest) (3666 stars) - Reliable PostgreSQL Backup & Restore
...
- [pgcopydb](https://github.com/dimitri/pgcopydb) (1429 stars) - Copy a Postgres database to a target Postgres server (pg_dump | pg_restore on steroids)
- [pgedge-vectorizer](https://github.com/pgEdge/pgedge-vectorizer) (30 stars) - A PostgreSQL extension to create chunk tables for existing text data, and populate them with embeddings using your favourite LLM.
...
- [quickjs](https://github.com/bellard/quickjs) (10500 stars) - Public repository of the QuickJS Javascript Engine.
...
- [spdk](https://github.com/spdk/spdk) (3510 stars) - Storage Performance Development Kit
...
- [tengine](https://github.com/alibaba/tengine) (13219 stars) - A distribution of Nginx with some advanced features
...
- [timescaledb](https://github.com/timescale/timescaledb) (22165 stars) - A time-series database for high-performance real-time analytics packaged as a Postgres extension
...
- [ttyd](https://github.com/tsl0922/ttyd) (11225 stars) - Share your terminal over the web
...
- [zstd](https://github.com/facebook/zstd) (26841 stars) - Zstandard - Fast real-time compression algorithm
