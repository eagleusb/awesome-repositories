...
- [ansible-collection-hardening](https://github.com/dev-sec/ansible-collection-hardening) (5395 stars) - This Ansible collection provides battle tested hardening for Linux, SSH, nginx, MySQL
