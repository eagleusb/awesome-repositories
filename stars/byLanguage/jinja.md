...
- [ansible-collection-hardening](https://github.com/dev-sec/ansible-collection-hardening) (5310 stars) - This Ansible collection provides battle tested hardening for Linux, SSH, nginx, MySQL
...
- [kubespray](https://github.com/kubernetes-sigs/kubespray) (18401 stars) - Deploy a Production Ready Kubernetes Cluster
- [netboot.xyz](https://github.com/netbootxyz/netboot.xyz) (11612 stars) - Your favorite operating systems in one place.  A network-based bootable operating system installer based on iPXE.
