...
- [guide](https://github.com/uber-go/guide) (17632 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4257 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [mindshub](https://github.com/mindsdb/mindshub) (39481 stars) - Make AI do actual work. Swap the model anytime — keep everything you've built.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4233 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
