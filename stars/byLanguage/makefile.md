...
- [guide](https://github.com/uber-go/guide) (17563 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4207 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [openhue-api](https://github.com/openhue/openhue-api) (191 stars) - OpenHue API is an open-source project that provides a comprehensive OpenAPI specification for the Philips Hue REST API
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4156 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
