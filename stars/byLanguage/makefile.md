...
- [hubble](https://github.com/cilium/hubble) (4132 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4025 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
