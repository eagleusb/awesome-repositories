...
- [guide](https://github.com/uber-go/guide) (17648 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4280 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [mindshub](https://github.com/mindsdb/mindshub) (39524 stars) - Make AI do actual work. Swap the model anytime — keep everything you've built.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4267 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
