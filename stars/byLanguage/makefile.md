...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (588 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17585 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4223 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2774 stars) - Just enough OS for KODI
- [minds](https://github.com/mindsdb/minds) (39327 stars) - General-purpose AI designed for knowledge workers — creators, strategists, and operators — and individuals seeking AI systems they can truly control to help them get work done, with full flexibility to extend and deploy anywhere (VPC, on-prem, or cloud).
- [openhue-api](https://github.com/openhue/openhue-api) (194 stars) - OpenHue API is an open-source project that provides a comprehensive OpenAPI specification for the Philips Hue REST API
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4174 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
