...
- [guide](https://github.com/uber-go/guide) (17413 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4146 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4047 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
