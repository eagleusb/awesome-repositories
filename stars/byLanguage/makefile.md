...
- [guide](https://github.com/uber-go/guide) (17707 stars) - The Uber Go Style Guide.
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2815 stars) - Just enough OS for KODI
- [mindshub](https://github.com/mindsdb/mindshub) (39739 stars) - The unified workspace where open-source models get things done for you.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4321 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
