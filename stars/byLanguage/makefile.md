...
- [guide](https://github.com/uber-go/guide) (17704 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4327 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2814 stars) - Just enough OS for KODI
- [mindshub](https://github.com/mindsdb/mindshub) (39734 stars) - The unified workspace where open-source models get things done for you.
- [openhue-api](https://github.com/openhue/openhue-api) (205 stars) - OpenHue API is an open-source project that provides a comprehensive OpenAPI specification for the Philips Hue REST API
- [pragmasevka](https://github.com/shytikov/pragmasevka) (447 stars) - Pragmata Pro doppelgänger made of Iosevka SS08
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4320 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
