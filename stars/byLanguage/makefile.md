...
- [guide](https://github.com/uber-go/guide) (17630 stars) - The Uber Go Style Guide.
...
- [mindshub](https://github.com/mindsdb/mindshub) (39471 stars) - Make AI do actual work. Swap the model anytime — keep everything you've built.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4231 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
