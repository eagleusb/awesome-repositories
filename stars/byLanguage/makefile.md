...
- [guide](https://github.com/uber-go/guide) (17723 stars) - The Uber Go Style Guide.
- [hellogopher](https://github.com/vincentbernat/hellogopher) (309 stars) - Makefile to build a Go project
- [hermit](https://github.com/pcaro90/hermit) (546 stars) - Hermit is a monospace font designed to be clear, pragmatic and very readable.
- [hubble](https://github.com/cilium/hubble) (4344 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2821 stars) - Just enough OS for KODI
- [mindshub](https://github.com/mindsdb/mindshub) (39763 stars) - The unified workspace where open-source models get things done for you.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4332 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
