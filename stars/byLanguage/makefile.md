...
- [minds](https://github.com/mindsdb/minds) (39372 stars) - Delegate anything. It comes back done.
...
- [spec](https://github.com/container-storage-interface/spec) (1477 stars) - Container Storage Interface (CSI) Specification.
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4186 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
