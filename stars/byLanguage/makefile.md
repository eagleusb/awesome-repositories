...
- [guide](https://github.com/uber-go/guide) (17457 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4170 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [openhue-api](https://github.com/openhue/openhue-api) (179 stars) - OpenHue API is an open-source project that provides a comprehensive OpenAPI specification for the Philips Hue REST API
- [pragmasevka](https://github.com/shytikov/pragmasevka) (423 stars) - Pragmata Pro doppelgänger made of Iosevka SS08
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4081 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
