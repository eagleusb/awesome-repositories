...
- [guide](https://github.com/uber-go/guide) (17421 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4157 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2732 stars) - Just enough OS for KODI
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4049 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
