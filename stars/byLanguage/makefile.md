...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (587 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
...
- [hubble](https://github.com/cilium/hubble) (4221 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2772 stars) - Just enough OS for KODI
- [minds](https://github.com/mindsdb/minds) (39324 stars) - General-purpose AI designed for knowledge workers — creators, strategists, and operators — and individuals seeking AI systems they can truly control to help them get work done, with full flexibility to extend and deploy anywhere (VPC, on-prem, or cloud).
...
- [spec](https://github.com/container-storage-interface/spec) (1473 stars) - Container Storage Interface (CSI) Specification.
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4172 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
