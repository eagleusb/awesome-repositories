...
- [guide](https://github.com/uber-go/guide) (17495 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4192 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [spec](https://github.com/container-storage-interface/spec) (1469 stars) - Container Storage Interface (CSI) Specification.
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4126 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
