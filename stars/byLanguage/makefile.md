...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (575 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4123 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
