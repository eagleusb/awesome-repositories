...
- [awesome-docker](https://github.com/veggiemonk/awesome-docker) (35791 stars) - :whale: A curated list of Docker resources and projects
...
- [guide](https://github.com/uber-go/guide) (17397 stars) - The Uber Go Style Guide.
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2709 stars) - Just enough OS for KODI
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4018 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
