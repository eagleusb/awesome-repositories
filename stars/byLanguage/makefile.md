...
- [hubble](https://github.com/cilium/hubble) (4333 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [mindshub](https://github.com/mindsdb/mindshub) (39746 stars) - The unified workspace where open-source models get things done for you.
...
- [pragmasevka](https://github.com/shytikov/pragmasevka) (448 stars) - Pragmata Pro doppelgänger made of Iosevka SS08
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4326 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
