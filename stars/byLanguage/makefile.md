...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (586 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17584 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4219 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [minds](https://github.com/mindsdb/minds) (39323 stars) - General-purpose AI designed for knowledge workers — creators, strategists, and operators — and individuals seeking AI systems they can truly control to help them get work done, with full flexibility to extend and deploy anywhere (VPC, on-prem, or cloud).
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4171 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
