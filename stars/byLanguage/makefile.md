...
- [guide](https://github.com/uber-go/guide) (17637 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4267 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2788 stars) - Just enough OS for KODI
- [mindshub](https://github.com/mindsdb/mindshub) (39509 stars) - Make AI do actual work. Swap the model anytime — keep everything you've built.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4248 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
