...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (557 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17429 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4158 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [spec](https://github.com/container-storage-interface/spec) (1464 stars) - Container Storage Interface (CSI) Specification.
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4055 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
