...
- [guide](https://github.com/uber-go/guide) (17582 stars) - The Uber Go Style Guide.
...
- [minds](https://github.com/mindsdb/minds) (39320 stars) - General-purpose AI designed for knowledge workers — creators, strategists, and operators — and individuals seeking AI systems they can truly control to help them get work done, with full flexibility to extend and deploy anywhere (VPC, on-prem, or cloud).
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4170 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
