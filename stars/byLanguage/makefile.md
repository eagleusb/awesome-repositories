...
- [hubble](https://github.com/cilium/hubble) (4265 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [mindshub](https://github.com/mindsdb/mindshub) (39501 stars) - Make AI do actual work. Swap the model anytime — keep everything you've built.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4242 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
