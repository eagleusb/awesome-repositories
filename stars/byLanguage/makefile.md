...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (577 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17539 stars) - The Uber Go Style Guide.
- [hellogopher](https://github.com/vincentbernat/hellogopher) (309 stars) - Makefile to build a Go project
- [hermit](https://github.com/pcaro90/hermit) (538 stars) - Hermit is a monospace font designed to be clear, pragmatic and very readable.
- [hubble](https://github.com/cilium/hubble) (4198 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2754 stars) - Just enough OS for KODI
- [openhue-api](https://github.com/openhue/openhue-api) (187 stars) - OpenHue API is an open-source project that provides a comprehensive OpenAPI specification for the Philips Hue REST API
- [pragmasevka](https://github.com/shytikov/pragmasevka) (432 stars) - Pragmata Pro doppelgänger made of Iosevka SS08
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4136 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
