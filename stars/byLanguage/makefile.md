...
- [mindshub](https://github.com/mindsdb/mindshub) (39498 stars) - Make AI do actual work. Swap the model anytime — keep everything you've built.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4240 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
