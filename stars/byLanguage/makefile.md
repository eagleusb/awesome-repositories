...
- [guide](https://github.com/uber-go/guide) (17449 stars) - The Uber Go Style Guide.
- [hellogopher](https://github.com/vincentbernat/hellogopher) (309 stars) - Makefile to build a Go project
- [hermit](https://github.com/pcaro90/hermit) (534 stars) - Hermit is a monospace font designed to be clear, pragmatic and very readable.
- [hubble](https://github.com/cilium/hubble) (4168 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4077 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
