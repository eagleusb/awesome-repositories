...
- [guide](https://github.com/uber-go/guide) (17641 stars) - The Uber Go Style Guide.
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2792 stars) - Just enough OS for KODI
- [mindshub](https://github.com/mindsdb/mindshub) (39517 stars) - Make AI do actual work. Swap the model anytime — keep everything you've built.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4255 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
