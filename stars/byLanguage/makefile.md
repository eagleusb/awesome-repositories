...
- [guide](https://github.com/uber-go/guide) (17677 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4321 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [mindshub](https://github.com/mindsdb/mindshub) (39686 stars) - The unified workspace where open-source models get things done for you.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4295 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
