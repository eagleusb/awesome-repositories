...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (574 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17490 stars) - The Uber Go Style Guide.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4118 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
