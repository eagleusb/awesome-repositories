...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (553 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17407 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4140 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2723 stars) - Just enough OS for KODI
- [openhue-api](https://github.com/openhue/openhue-api) (175 stars) - OpenHue API is an open-source project that provides a comprehensive OpenAPI specification for the Philips Hue REST API
- [pragmasevka](https://github.com/shytikov/pragmasevka) (415 stars) - Pragmata Pro doppelgänger made of Iosevka SS08
...
- [spec](https://github.com/container-storage-interface/spec) (1461 stars) - Container Storage Interface (CSI) Specification.
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4037 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
