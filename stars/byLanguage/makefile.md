...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (563 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17453 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4169 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4079 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
