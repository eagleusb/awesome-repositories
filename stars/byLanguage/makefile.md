...
- [hubble](https://github.com/cilium/hubble) (4286 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2797 stars) - Just enough OS for KODI
- [mindshub](https://github.com/mindsdb/mindshub) (39562 stars) - The unified workspace where open-source models get things done for you.
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4268 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
