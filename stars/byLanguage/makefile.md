...
- [deezer-linux](https://github.com/aunetx/deezer-linux) (558 stars) - An universal linux port of deezer, supporting Flatpak, Appimage, Snap, RPM, DEB...
- [guide](https://github.com/uber-go/guide) (17432 stars) - The Uber Go Style Guide.
...
- [hubble](https://github.com/cilium/hubble) (4159 stars) - Hubble - Network, Service & Security Observability for Kubernetes using eBPF
...
- [LibreELEC.tv](https://github.com/LibreELEC/LibreELEC.tv) (2733 stars) - Just enough OS for KODI
...
- [spec](https://github.com/container-storage-interface/spec) (1465 stars) - Container Storage Interface (CSI) Specification.
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) (4058 stars) - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking (Windows, macOS, Linux & Docker)
