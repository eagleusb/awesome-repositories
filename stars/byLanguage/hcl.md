...
- [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) (4976 stars) - Terraform module to create Amazon Elastic Kubernetes (EKS) resources 🇺🇦
...
- [terraform-hcloud-kubernetes](https://github.com/hcloud-k8s/terraform-hcloud-kubernetes) (683 stars) - Terraform Module to Deploy a Highly Available, Production-Ready Talos Kubernetes Cluster on Hetzner Cloud
...
- [vault-on-gke](https://github.com/sethvargo/vault-on-gke) (497 stars) - Run @HashiCorp Vault on Google Kubernetes Engine (GKE) with Terraform
