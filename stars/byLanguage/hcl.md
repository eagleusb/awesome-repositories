...
- [pgbouncer-containers](https://github.com/cloudnative-pg/pgbouncer-containers) (20 stars) - Optimized images for PgBouncer connection pooling.
...
- [terraform-aws-alternat](https://github.com/chime/terraform-aws-alternat) (1262 stars) - High availability implementation of AWS NAT instances.
...
- [terraform-aws-github-runner](https://github.com/github-aws-runners/terraform-aws-github-runner) (3126 stars) - Terraform module for scalable GitHub action runners on AWS
...
- [terraform-google-kubernetes-engine](https://github.com/terraform-google-modules/terraform-google-kubernetes-engine) (1280 stars) - Configures opinionated GKE clusters
- [terraform-guides](https://github.com/hashicorp/terraform-guides) (1502 stars) - Example usage of HashiCorp Terraform
- [terraform-hcloud-kubernetes](https://github.com/hcloud-k8s/terraform-hcloud-kubernetes) (705 stars) - Terraform Module to Deploy a Highly Available, Production-Ready Talos Kubernetes Cluster on Hetzner Cloud
