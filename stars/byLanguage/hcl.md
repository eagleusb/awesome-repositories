## HCL (22 repositories) 
- [accelerated-platforms](https://github.com/GoogleCloudPlatform/accelerated-platforms) (95 stars) - This repository is a collection of accelerated platform best practices, reference architectures, example use cases, reference implementations, and various other assets on Google Cloud.
...
- [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) (4934 stars) - Terraform module to create Amazon Elastic Kubernetes (EKS) resources 🇺🇦
...
- [terraform-aws-rds](https://github.com/terraform-aws-modules/terraform-aws-rds) (953 stars) - Terraform module to create AWS RDS resources 🇺🇦
...
- [terraform-google-kubernetes-engine](https://github.com/terraform-google-modules/terraform-google-kubernetes-engine) (1260 stars) - Configures opinionated GKE clusters
- [terraform-guides](https://github.com/hashicorp/terraform-guides) (1495 stars) - Example usage of HashiCorp Terraform
- [terraform-hcloud-kubernetes](https://github.com/hcloud-k8s/terraform-hcloud-kubernetes) (659 stars) - Terraform Module to Deploy a Highly Available, Production-Ready Talos Kubernetes Cluster on Hetzner Cloud
...
- [terragrunt-atlantis-config](https://github.com/transcend-io/terragrunt-atlantis-config) (738 stars) - Generate Atlantis config for Terragrunt projects.
