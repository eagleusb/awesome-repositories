...
- [cachix](https://github.com/cachix/cachix) (1018 stars) - Command line client for Nix binary cache hosting:
...
- [postgrest](https://github.com/PostgREST/postgrest) (26682 stars) - REST API for any Postgres database
...
- [shellcheck](https://github.com/koalaman/shellcheck) (39147 stars) - ShellCheck, a static analysis tool for shell scripts
- [simplex-chat](https://github.com/simplex-chat/simplex-chat) (10725 stars) - SimpleX - the first messaging network operating without user identifiers of any kind - 100% private by design! iOS, Android and desktop apps 📱!
- [simplexmq](https://github.com/simplex-chat/simplexmq) (769 stars) - ⚙️ SimpleXMQ - A reference implementation of the SimpleX Messaging Protocol for simplex queues over public networks.
