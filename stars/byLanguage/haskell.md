...
- [cachix](https://github.com/cachix/cachix) (1016 stars) - Command line client for Nix binary cache hosting:
...
- [postgrest](https://github.com/PostgREST/postgrest) (26679 stars) - REST API for any Postgres database
...
- [simplex-chat](https://github.com/simplex-chat/simplex-chat) (10720 stars) - SimpleX - the first messaging network operating without user identifiers of any kind - 100% private by design! iOS, Android and desktop apps 📱!
- [simplexmq](https://github.com/simplex-chat/simplexmq) (768 stars) - ⚙️ SimpleXMQ - A reference implementation of the SimpleX Messaging Protocol for simplex queues over public networks.
