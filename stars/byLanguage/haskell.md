...
- [cachix](https://github.com/cachix/cachix) (1064 stars) - Command line client for Nix binary cache hosting:
...
- [postgrest](https://github.com/PostgREST/postgrest) (27211 stars) - REST API for any Postgres database
...
- [shellcheck](https://github.com/koalaman/shellcheck) (39541 stars) - ShellCheck, a static analysis tool for shell scripts
- [simplex-chat](https://github.com/simplex-chat/simplex-chat) (11215 stars) - SimpleX - the first messaging network operating without user identifiers of any kind - 100% private by design! iOS, Android and desktop apps 📱!
