...
- [appwrite](https://github.com/appwrite/appwrite) (57454 stars) - Appwrite® - complete cloud infrastructure for your web, mobile and AI apps. Including Auth, Databases, Storage, Functions, Messaging, Hosting, Realtime and more
...
- [Baikal](https://github.com/sabre-io/Baikal) (3319 stars) - Baïkal is a Calendar+Contacts server
...
- [grav](https://github.com/getgrav/grav) (15671 stars) - Modern, Crazy Fast, Ridiculously Easy and Amazingly Powerful Flat-File CMS powered by PHP, Markdown, Twig, and Symfony
...
- [invoiceninja](https://github.com/invoiceninja/invoiceninja) (10106 stars) - A source-available invoice, quote, project and time-tracking app built with Laravel
...
- [librenms](https://github.com/librenms/librenms) (4904 stars) - Community-based GPL-licensed network monitoring system
...
- [panel](https://github.com/pterodactyl/panel) (9253 stars) - Pterodactyl® is a free, open-source game server management panel built with PHP, React, and Go. Designed with security in mind, Pterodactyl runs all game servers in isolated Docker containers while exposing a beautiful and intuitive UI to end users.
...
- [SecLists](https://github.com/danielmiessler/SecLists) (73690 stars) - SecLists is the security tester's companion. It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
