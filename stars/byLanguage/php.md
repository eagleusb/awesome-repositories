...
- [grav](https://github.com/getgrav/grav) (15420 stars) - Modern, Crazy Fast, Ridiculously Easy and Amazingly Powerful Flat-File CMS powered by PHP, Markdown, Twig, and Symfony
...
- [kanboard](https://github.com/kanboard/kanboard) (9513 stars) - Kanban project management software
...
- [MISP](https://github.com/MISP/MISP) (6192 stars) - MISP (core software) - Open Source Threat Intelligence and Sharing Platform
...
- [panel](https://github.com/pterodactyl/panel) (8709 stars) - Pterodactyl® is a free, open-source game server management panel built with PHP, React, and Go. Designed with security in mind, Pterodactyl runs all game servers in isolated Docker containers while exposing a beautiful and intuitive UI to end users.
- [paseto](https://github.com/paragonie/paseto) (3374 stars) - Platform-Agnostic Security Tokens
...
- [SecLists](https://github.com/danielmiessler/SecLists) (69626 stars) - SecLists is the security tester's companion. It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
