...
- [appwrite](https://github.com/appwrite/appwrite) (57441 stars) - Appwrite® - complete cloud infrastructure for your web, mobile and AI apps. Including Auth, Databases, Storage, Functions, Messaging, Hosting, Realtime and more
...
- [Baikal](https://github.com/sabre-io/Baikal) (3318 stars) - Baïkal is a Calendar+Contacts server
- [cachet](https://github.com/cachethq/cachet) (15249 stars) - 🚦 Cachet, the open source, self-hosted status page system.
- [cacti](https://github.com/Cacti/cacti) (1871 stars) - Cacti ™
- [crater](https://github.com/crater-invoice-inc/crater) (8347 stars) - Open Source Invoicing Solution for Individuals & Businesses
- [cypht](https://github.com/cypht-org/cypht) (1735 stars) - Cypht: Lightweight Open Source webmail aggregator [PHP, JS].  Supports IMAP/SMTP, JMAP and EWS (Exchange Web Services)
...
- [grav](https://github.com/getgrav/grav) (15670 stars) - Modern, Crazy Fast, Ridiculously Easy and Amazingly Powerful Flat-File CMS powered by PHP, Markdown, Twig, and Symfony
...
- [invoiceninja](https://github.com/invoiceninja/invoiceninja) (10104 stars) - A source-available invoice, quote, project and time-tracking app built with Laravel
...
- [kanboard](https://github.com/kanboard/kanboard) (9881 stars) - Kanban project management software
...
- [panel](https://github.com/pterodactyl/panel) (9250 stars) - Pterodactyl® is a free, open-source game server management panel built with PHP, React, and Go. Designed with security in mind, Pterodactyl runs all game servers in isolated Docker containers while exposing a beautiful and intuitive UI to end users.
...
- [roundcubemail](https://github.com/roundcube/roundcubemail) (7188 stars) - The Roundcube Webmail suite
- [SecLists](https://github.com/danielmiessler/SecLists) (73677 stars) - SecLists is the security tester's companion. It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
...
- [TeamPass](https://github.com/nilsteampassnet/TeamPass) (1827 stars) - Collaborative Passwords Manager
...
- [UNIT3D](https://github.com/HDInnovations/UNIT3D) (2428 stars) - UNIT3D is a private torrent tracker built using Laravel, Livewire and AlpineJS.
- [wallabag](https://github.com/wallabag/wallabag) (12982 stars) - wallabag is a self hostable application for saving web pages: Save and classify articles. Read them later. Freely.
